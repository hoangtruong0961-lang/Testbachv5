var rm=Object.defineProperty;var am=(e,t,i)=>t in e?rm(e,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[t]=i;var bs=(e,t,i)=>am(e,typeof t!="symbol"?t+"":t,i);/*!
 * ONNX Runtime Web v1.23.2
 * Copyright (c) Microsoft Corporation. All rights reserved.
 * Licensed under the MIT License.
 */var Aa=Object.defineProperty,nm=Object.getOwnPropertyDescriptor,sm=Object.getOwnPropertyNames,om=Object.prototype.hasOwnProperty,um=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,i)=>(typeof require<"u"?require:t)[i]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')}),q=(e,t)=>()=>(e&&(t=e(e=0)),t),Gt=(e,t)=>{for(var i in t)Aa(e,i,{get:t[i],enumerable:!0})},lm=(e,t,i,a)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of sm(t))!om.call(e,n)&&n!==i&&Aa(e,n,{get:()=>t[n],enumerable:!(a=nm(t,n))||a.enumerable});return e},ci=e=>lm(Aa({},"__esModule",{value:!0}),e),Yt,mt,Bt,ws,Jl,ed=q(()=>{Yt=new Map,mt=[],Bt=(e,t,i)=>{if(t&&typeof t.init=="function"&&typeof t.createInferenceSessionHandler=="function"){let a=Yt.get(e);if(a===void 0)Yt.set(e,{backend:t,priority:i});else{if(a.priority>i)return;if(a.priority===i&&a.backend!==t)throw new Error(`cannot register backend "${e}" using priority ${i}`)}if(i>=0){let n=mt.indexOf(e);n!==-1&&mt.splice(n,1);for(let r=0;r<mt.length;r++)if(Yt.get(mt[r]).priority<=i){mt.splice(r,0,e);return}mt.push(e)}return}throw new TypeError("not a valid backend")},ws=async e=>{let t=Yt.get(e);if(!t)return"backend not found.";if(t.initialized)return t.backend;if(t.aborted)return t.error;{let i=!!t.initPromise;try{return i||(t.initPromise=t.backend.init(e)),await t.initPromise,t.initialized=!0,t.backend}catch(a){return i||(t.error=`${a}`,t.aborted=!0),t.error}finally{delete t.initPromise}}},Jl=async e=>{let t=e.executionProviders||[],i=t.map(p=>typeof p=="string"?p:p.name),a=i.length===0?mt:i,n,r=[],o=new Set;for(let p of a){let d=await ws(p);typeof d=="string"?r.push({name:p,err:d}):(n||(n=d),n===d&&o.add(p))}if(!n)throw new Error(`no available backend found. ERR: ${r.map(p=>`[${p.name}] ${p.err}`).join(", ")}`);for(let{name:p,err:d}of r)i.includes(p)&&console.warn(`removing requested execution provider "${p}" from session options because it is not available: ${d}`);let u=t.filter(p=>o.has(typeof p=="string"?p:p.name));return[n,new Proxy(e,{get:(p,d)=>d==="executionProviders"?u:Reflect.get(p,d)})]}}),dm=q(()=>{ed()}),td,pm=q(()=>{td="1.23.2"}),yr,Ie,id=q(()=>{pm(),yr="warning",Ie={wasm:{},webgl:{},webgpu:{},versions:{common:td},set logLevel(e){if(e!==void 0){if(typeof e!="string"||["verbose","info","warning","error","fatal"].indexOf(e)===-1)throw new Error(`Unsupported logging level: ${e}`);yr=e}},get logLevel(){return yr}},Object.defineProperty(Ie,"logLevel",{enumerable:!0})}),be,cm=q(()=>{id(),be=Ie}),rd,ad,fm=q(()=>{rd=(e,t)=>{let i=typeof document<"u"?document.createElement("canvas"):new OffscreenCanvas(1,1);i.width=e.dims[3],i.height=e.dims[2];let a=i.getContext("2d");if(a!=null){let n,r;(t==null?void 0:t.tensorLayout)!==void 0&&t.tensorLayout==="NHWC"?(n=e.dims[2],r=e.dims[3]):(n=e.dims[3],r=e.dims[2]);let o=(t==null?void 0:t.format)!==void 0?t.format:"RGB",u=t==null?void 0:t.norm,p,d;u===void 0||u.mean===void 0?p=[255,255,255,255]:typeof u.mean=="number"?p=[u.mean,u.mean,u.mean,u.mean]:(p=[u.mean[0],u.mean[1],u.mean[2],0],u.mean[3]!==void 0&&(p[3]=u.mean[3])),u===void 0||u.bias===void 0?d=[0,0,0,0]:typeof u.bias=="number"?d=[u.bias,u.bias,u.bias,u.bias]:(d=[u.bias[0],u.bias[1],u.bias[2],0],u.bias[3]!==void 0&&(d[3]=u.bias[3]));let f=r*n,m=0,g=f,_=f*2,b=-1;o==="RGBA"?(m=0,g=f,_=f*2,b=f*3):o==="RGB"?(m=0,g=f,_=f*2):o==="RBG"&&(m=0,_=f,g=f*2);for(let w=0;w<r;w++)for(let C=0;C<n;C++){let v=(e.data[m++]-d[0])*p[0],$=(e.data[g++]-d[1])*p[1],T=(e.data[_++]-d[2])*p[2],k=b===-1?255:(e.data[b++]-d[3])*p[3];a.fillStyle="rgba("+v+","+$+","+T+","+k+")",a.fillRect(C,w,1,1)}if("toDataURL"in i)return i.toDataURL();throw new Error("toDataURL is not supported")}else throw new Error("Can not access image data")},ad=(e,t)=>{let i=typeof document<"u"?document.createElement("canvas").getContext("2d"):new OffscreenCanvas(1,1).getContext("2d"),a;if(i!=null){let n,r,o;(t==null?void 0:t.tensorLayout)!==void 0&&t.tensorLayout==="NHWC"?(n=e.dims[2],r=e.dims[1],o=e.dims[3]):(n=e.dims[3],r=e.dims[2],o=e.dims[1]);let u=t!==void 0&&t.format!==void 0?t.format:"RGB",p=t==null?void 0:t.norm,d,f;p===void 0||p.mean===void 0?d=[255,255,255,255]:typeof p.mean=="number"?d=[p.mean,p.mean,p.mean,p.mean]:(d=[p.mean[0],p.mean[1],p.mean[2],255],p.mean[3]!==void 0&&(d[3]=p.mean[3])),p===void 0||p.bias===void 0?f=[0,0,0,0]:typeof p.bias=="number"?f=[p.bias,p.bias,p.bias,p.bias]:(f=[p.bias[0],p.bias[1],p.bias[2],0],p.bias[3]!==void 0&&(f[3]=p.bias[3]));let m=r*n;if(t!==void 0&&(t.format!==void 0&&o===4&&t.format!=="RGBA"||o===3&&t.format!=="RGB"&&t.format!=="BGR"))throw new Error("Tensor format doesn't match input tensor dims");let g=4,_=0,b=1,w=2,C=3,v=0,$=m,T=m*2,k=-1;u==="RGBA"?(v=0,$=m,T=m*2,k=m*3):u==="RGB"?(v=0,$=m,T=m*2):u==="RBG"&&(v=0,T=m,$=m*2),a=i.createImageData(n,r);for(let S=0;S<r*n;_+=g,b+=g,w+=g,C+=g,S++)a.data[_]=(e.data[v++]-f[0])*d[0],a.data[b]=(e.data[$++]-f[1])*d[1],a.data[w]=(e.data[T++]-f[2])*d[2],a.data[C]=k===-1?255:(e.data[k++]-f[3])*d[3]}else throw new Error("Can not access image data");return a}}),Ti,nd,sd,od,ud,ld,hm=q(()=>{Oa(),Ti=(e,t)=>{if(e===void 0)throw new Error("Image buffer must be defined");if(t.height===void 0||t.width===void 0)throw new Error("Image height and width must be defined");if(t.tensorLayout==="NHWC")throw new Error("NHWC Tensor layout is not supported yet");let{height:i,width:a}=t,n=t.norm??{mean:255,bias:0},r,o;typeof n.mean=="number"?r=[n.mean,n.mean,n.mean,n.mean]:r=[n.mean[0],n.mean[1],n.mean[2],n.mean[3]??255],typeof n.bias=="number"?o=[n.bias,n.bias,n.bias,n.bias]:o=[n.bias[0],n.bias[1],n.bias[2],n.bias[3]??0];let u=t.format!==void 0?t.format:"RGBA",p=t.tensorFormat!==void 0&&t.tensorFormat!==void 0?t.tensorFormat:"RGB",d=i*a,f=p==="RGBA"?new Float32Array(d*4):new Float32Array(d*3),m=4,g=0,_=1,b=2,w=3,C=0,v=d,$=d*2,T=-1;u==="RGB"&&(m=3,g=0,_=1,b=2,w=-1),p==="RGBA"?T=d*3:p==="RBG"?(C=0,$=d,v=d*2):p==="BGR"&&($=0,v=d,C=d*2);for(let k=0;k<d;k++,g+=m,b+=m,_+=m,w+=m)f[C++]=(e[g]+o[0])/r[0],f[v++]=(e[_]+o[1])/r[1],f[$++]=(e[b]+o[2])/r[2],T!==-1&&w!==-1&&(f[T++]=(e[w]+o[3])/r[3]);return p==="RGBA"?new Ue("float32",f,[1,4,i,a]):new Ue("float32",f,[1,3,i,a])},nd=async(e,t)=>{let i=typeof HTMLImageElement<"u"&&e instanceof HTMLImageElement,a=typeof ImageData<"u"&&e instanceof ImageData,n=typeof ImageBitmap<"u"&&e instanceof ImageBitmap,r=typeof e=="string",o,u=t??{},p=()=>{if(typeof document<"u")return document.createElement("canvas");if(typeof OffscreenCanvas<"u")return new OffscreenCanvas(1,1);throw new Error("Canvas is not supported")},d=f=>typeof HTMLCanvasElement<"u"&&f instanceof HTMLCanvasElement||f instanceof OffscreenCanvas?f.getContext("2d"):null;if(i){let f=p();f.width=e.width,f.height=e.height;let m=d(f);if(m!=null){let g=e.height,_=e.width;if(t!==void 0&&t.resizedHeight!==void 0&&t.resizedWidth!==void 0&&(g=t.resizedHeight,_=t.resizedWidth),t!==void 0){if(u=t,t.tensorFormat!==void 0)throw new Error("Image input config format must be RGBA for HTMLImageElement");u.tensorFormat="RGBA",u.height=g,u.width=_}else u.tensorFormat="RGBA",u.height=g,u.width=_;m.drawImage(e,0,0),o=m.getImageData(0,0,_,g).data}else throw new Error("Can not access image data")}else if(a){let f,m;if(t!==void 0&&t.resizedWidth!==void 0&&t.resizedHeight!==void 0?(f=t.resizedHeight,m=t.resizedWidth):(f=e.height,m=e.width),t!==void 0&&(u=t),u.format="RGBA",u.height=f,u.width=m,t!==void 0){let g=p();g.width=m,g.height=f;let _=d(g);if(_!=null)_.putImageData(e,0,0),o=_.getImageData(0,0,m,f).data;else throw new Error("Can not access image data")}else o=e.data}else if(n){if(t===void 0)throw new Error("Please provide image config with format for Imagebitmap");let f=p();f.width=e.width,f.height=e.height;let m=d(f);if(m!=null){let g=e.height,_=e.width;return m.drawImage(e,0,0,_,g),o=m.getImageData(0,0,_,g).data,u.height=g,u.width=_,Ti(o,u)}else throw new Error("Can not access image data")}else{if(r)return new Promise((f,m)=>{let g=p(),_=d(g);if(!e||!_)return m();let b=new Image;b.crossOrigin="Anonymous",b.src=e,b.onload=()=>{g.width=b.width,g.height=b.height,_.drawImage(b,0,0,g.width,g.height);let w=_.getImageData(0,0,g.width,g.height);u.height=g.height,u.width=g.width,f(Ti(w.data,u))}});throw new Error("Input data provided is not supported - aborted tensor creation")}if(o!==void 0)return Ti(o,u);throw new Error("Input data provided is not supported - aborted tensor creation")},sd=(e,t)=>{let{width:i,height:a,download:n,dispose:r}=t,o=[1,a,i,4];return new Ue({location:"texture",type:"float32",texture:e,dims:o,download:n,dispose:r})},od=(e,t)=>{let{dataType:i,dims:a,download:n,dispose:r}=t;return new Ue({location:"gpu-buffer",type:i??"float32",gpuBuffer:e,dims:a,download:n,dispose:r})},ud=(e,t)=>{let{dataType:i,dims:a,download:n,dispose:r}=t;return new Ue({location:"ml-tensor",type:i??"float32",mlTensor:e,dims:a,download:n,dispose:r})},ld=(e,t,i)=>new Ue({location:"cpu-pinned",type:e,data:t,dims:i??[t.length]})}),At,oi,br,dd,mm=q(()=>{At=new Map([["float32",Float32Array],["uint8",Uint8Array],["int8",Int8Array],["uint16",Uint16Array],["int16",Int16Array],["int32",Int32Array],["bool",Uint8Array],["float64",Float64Array],["uint32",Uint32Array],["int4",Uint8Array],["uint4",Uint8Array]]),oi=new Map([[Float32Array,"float32"],[Uint8Array,"uint8"],[Int8Array,"int8"],[Uint16Array,"uint16"],[Int16Array,"int16"],[Int32Array,"int32"],[Float64Array,"float64"],[Uint32Array,"uint32"]]),br=!1,dd=()=>{if(!br){br=!0;let e=typeof BigInt64Array<"u"&&BigInt64Array.from,t=typeof BigUint64Array<"u"&&BigUint64Array.from,i=globalThis.Float16Array,a=typeof i<"u"&&i.from;e&&(At.set("int64",BigInt64Array),oi.set(BigInt64Array,"int64")),t&&(At.set("uint64",BigUint64Array),oi.set(BigUint64Array,"uint64")),a?(At.set("float16",i),oi.set(i,"float16")):At.set("float16",Uint16Array)}}}),pd,cd,gm=q(()=>{Oa(),pd=e=>{let t=1;for(let i=0;i<e.length;i++){let a=e[i];if(typeof a!="number"||!Number.isSafeInteger(a))throw new TypeError(`dims[${i}] must be an integer, got: ${a}`);if(a<0)throw new RangeError(`dims[${i}] must be a non-negative integer, got: ${a}`);t*=a}return t},cd=(e,t)=>{switch(e.location){case"cpu":return new Ue(e.type,e.data,t);case"cpu-pinned":return new Ue({location:"cpu-pinned",data:e.data,type:e.type,dims:t});case"texture":return new Ue({location:"texture",texture:e.texture,type:e.type,dims:t});case"gpu-buffer":return new Ue({location:"gpu-buffer",gpuBuffer:e.gpuBuffer,type:e.type,dims:t});case"ml-tensor":return new Ue({location:"ml-tensor",mlTensor:e.mlTensor,type:e.type,dims:t});default:throw new Error(`tensorReshape: tensor location ${e.location} is not supported`)}}}),Ue,Oa=q(()=>{fm(),hm(),mm(),gm(),Ue=class{constructor(e,t,i){dd();let a,n;if(typeof e=="object"&&"location"in e)switch(this.dataLocation=e.location,a=e.type,n=e.dims,e.location){case"cpu-pinned":{let o=At.get(a);if(!o)throw new TypeError(`unsupported type "${a}" to create tensor from pinned buffer`);if(!(e.data instanceof o))throw new TypeError(`buffer should be of type ${o.name}`);this.cpuData=e.data;break}case"texture":{if(a!=="float32")throw new TypeError(`unsupported type "${a}" to create tensor from texture`);this.gpuTextureData=e.texture,this.downloader=e.download,this.disposer=e.dispose;break}case"gpu-buffer":{if(a!=="float32"&&a!=="float16"&&a!=="int32"&&a!=="int64"&&a!=="uint32"&&a!=="uint8"&&a!=="bool"&&a!=="uint4"&&a!=="int4")throw new TypeError(`unsupported type "${a}" to create tensor from gpu buffer`);this.gpuBufferData=e.gpuBuffer,this.downloader=e.download,this.disposer=e.dispose;break}case"ml-tensor":{if(a!=="float32"&&a!=="float16"&&a!=="int32"&&a!=="int64"&&a!=="uint32"&&a!=="uint64"&&a!=="int8"&&a!=="uint8"&&a!=="bool"&&a!=="uint4"&&a!=="int4")throw new TypeError(`unsupported type "${a}" to create tensor from MLTensor`);this.mlTensorData=e.mlTensor,this.downloader=e.download,this.disposer=e.dispose;break}default:throw new Error(`Tensor constructor: unsupported location '${this.dataLocation}'`)}else{let o,u;if(typeof e=="string")if(a=e,u=i,e==="string"){if(!Array.isArray(t))throw new TypeError("A string tensor's data must be a string array.");o=t}else{let p=At.get(e);if(p===void 0)throw new TypeError(`Unsupported tensor type: ${e}.`);if(Array.isArray(t)){if(e==="float16"&&p===Uint16Array||e==="uint4"||e==="int4")throw new TypeError(`Creating a ${e} tensor from number array is not supported. Please use ${p.name} as data.`);e==="uint64"||e==="int64"?o=p.from(t,BigInt):o=p.from(t)}else if(t instanceof p)o=t;else if(t instanceof Uint8ClampedArray)if(e==="uint8")o=Uint8Array.from(t);else throw new TypeError("A Uint8ClampedArray tensor's data must be type of uint8");else if(e==="float16"&&t instanceof Uint16Array&&p!==Uint16Array)o=new globalThis.Float16Array(t.buffer,t.byteOffset,t.length);else throw new TypeError(`A ${a} tensor's data must be type of ${p}`)}else if(u=t,Array.isArray(e)){if(e.length===0)throw new TypeError("Tensor type cannot be inferred from an empty array.");let p=typeof e[0];if(p==="string")a="string",o=e;else if(p==="boolean")a="bool",o=Uint8Array.from(e);else throw new TypeError(`Invalid element type of data array: ${p}.`)}else if(e instanceof Uint8ClampedArray)a="uint8",o=Uint8Array.from(e);else{let p=oi.get(e.constructor);if(p===void 0)throw new TypeError(`Unsupported type for tensor data: ${e.constructor}.`);a=p,o=e}if(u===void 0)u=[o.length];else if(!Array.isArray(u))throw new TypeError("A tensor's dims must be a number array");n=u,this.cpuData=o,this.dataLocation="cpu"}let r=pd(n);if(this.cpuData&&r!==this.cpuData.length&&!((a==="uint4"||a==="int4")&&Math.ceil(r/2)===this.cpuData.length))throw new Error(`Tensor's size(${r}) does not match data length(${this.cpuData.length}).`);this.type=a,this.dims=n,this.size=r}static async fromImage(e,t){return nd(e,t)}static fromTexture(e,t){return sd(e,t)}static fromGpuBuffer(e,t){return od(e,t)}static fromMLTensor(e,t){return ud(e,t)}static fromPinnedBuffer(e,t,i){return ld(e,t,i)}toDataURL(e){return rd(this,e)}toImageData(e){return ad(this,e)}get data(){if(this.ensureValid(),!this.cpuData)throw new Error("The data is not on CPU. Use `getData()` to download GPU data to CPU, or use `texture` or `gpuBuffer` property to access the GPU data directly.");return this.cpuData}get location(){return this.dataLocation}get texture(){if(this.ensureValid(),!this.gpuTextureData)throw new Error("The data is not stored as a WebGL texture.");return this.gpuTextureData}get gpuBuffer(){if(this.ensureValid(),!this.gpuBufferData)throw new Error("The data is not stored as a WebGPU buffer.");return this.gpuBufferData}get mlTensor(){if(this.ensureValid(),!this.mlTensorData)throw new Error("The data is not stored as a WebNN MLTensor.");return this.mlTensorData}async getData(e){switch(this.ensureValid(),this.dataLocation){case"cpu":case"cpu-pinned":return this.data;case"texture":case"gpu-buffer":case"ml-tensor":{if(!this.downloader)throw new Error("The current tensor is not created with a specified data downloader.");if(this.isDownloading)throw new Error("The current tensor is being downloaded.");try{this.isDownloading=!0;let t=await this.downloader();return this.downloader=void 0,this.dataLocation="cpu",this.cpuData=t,e&&this.disposer&&(this.disposer(),this.disposer=void 0),t}finally{this.isDownloading=!1}}default:throw new Error(`cannot get data from location: ${this.dataLocation}`)}}dispose(){if(this.isDownloading)throw new Error("The current tensor is being downloaded.");this.disposer&&(this.disposer(),this.disposer=void 0),this.cpuData=void 0,this.gpuTextureData=void 0,this.gpuBufferData=void 0,this.mlTensorData=void 0,this.downloader=void 0,this.isDownloading=void 0,this.dataLocation="none"}ensureValid(){if(this.dataLocation==="none")throw new Error("The tensor is disposed.")}reshape(e){if(this.ensureValid(),this.downloader||this.disposer)throw new Error("Cannot reshape a tensor that owns GPU resource.");return cd(this,e)}}}),Ye,fd=q(()=>{Oa(),Ye=Ue}),fi,wr,Xe,Le,yt,bt,hd=q(()=>{id(),fi=(e,t)=>{(typeof Ie.trace>"u"?!Ie.wasm.trace:!Ie.trace)||console.timeStamp(`${e}::ORT::${t}`)},wr=(e,t)=>{var n;let i=((n=new Error().stack)==null?void 0:n.split(/\r\n|\r|\n/g))||[],a=!1;for(let r=0;r<i.length;r++){if(a&&!i[r].includes("TRACE_FUNC")){let o=`FUNC_${e}::${i[r].trim().split(" ")[1]}`;t&&(o+=`::${t}`),fi("CPU",o);return}i[r].includes("TRACE_FUNC")&&(a=!0)}},Xe=e=>{(typeof Ie.trace>"u"?!Ie.wasm.trace:!Ie.trace)||wr("BEGIN",e)},Le=e=>{(typeof Ie.trace>"u"?!Ie.wasm.trace:!Ie.trace)||wr("END",e)},yt=e=>{(typeof Ie.trace>"u"?!Ie.wasm.trace:!Ie.trace)||console.time(`ORT::${e}`)},bt=e=>{(typeof Ie.trace>"u"?!Ie.wasm.trace:!Ie.trace)||console.timeEnd(`ORT::${e}`)}}),md,_m=q(()=>{ed(),fd(),hd(),md=class gd{constructor(t){this.handler=t}async run(t,i,a){Xe(),yt("InferenceSession.run");let n={},r={};if(typeof t!="object"||t===null||t instanceof Ye||Array.isArray(t))throw new TypeError("'feeds' must be an object that use input names as keys and OnnxValue as corresponding values.");let o=!0;if(typeof i=="object"){if(i===null)throw new TypeError("Unexpected argument[1]: cannot be null.");if(i instanceof Ye)throw new TypeError("'fetches' cannot be a Tensor");if(Array.isArray(i)){if(i.length===0)throw new TypeError("'fetches' cannot be an empty array.");o=!1;for(let d of i){if(typeof d!="string")throw new TypeError("'fetches' must be a string array or an object.");if(this.outputNames.indexOf(d)===-1)throw new RangeError(`'fetches' contains invalid output name: ${d}.`);n[d]=null}if(typeof a=="object"&&a!==null)r=a;else if(typeof a<"u")throw new TypeError("'options' must be an object.")}else{let d=!1,f=Object.getOwnPropertyNames(i);for(let m of this.outputNames)if(f.indexOf(m)!==-1){let g=i[m];(g===null||g instanceof Ye)&&(d=!0,o=!1,n[m]=g)}if(d){if(typeof a=="object"&&a!==null)r=a;else if(typeof a<"u")throw new TypeError("'options' must be an object.")}else r=i}}else if(typeof i<"u")throw new TypeError("Unexpected argument[1]: must be 'fetches' or 'options'.");for(let d of this.inputNames)if(typeof t[d]>"u")throw new Error(`input '${d}' is missing in 'feeds'.`);if(o)for(let d of this.outputNames)n[d]=null;let u=await this.handler.run(t,n,r),p={};for(let d in u)if(Object.hasOwnProperty.call(u,d)){let f=u[d];f instanceof Ye?p[d]=f:p[d]=new Ye(f.type,f.data,f.dims)}return bt("InferenceSession.run"),Le(),p}async release(){return this.handler.dispose()}static async create(t,i,a,n){Xe(),yt("InferenceSession.create");let r,o={};if(typeof t=="string"){if(r=t,typeof i=="object"&&i!==null)o=i;else if(typeof i<"u")throw new TypeError("'options' must be an object.")}else if(t instanceof Uint8Array){if(r=t,typeof i=="object"&&i!==null)o=i;else if(typeof i<"u")throw new TypeError("'options' must be an object.")}else if(t instanceof ArrayBuffer||typeof SharedArrayBuffer<"u"&&t instanceof SharedArrayBuffer){let f=t,m=0,g=t.byteLength;if(typeof i=="object"&&i!==null)o=i;else if(typeof i=="number"){if(m=i,!Number.isSafeInteger(m))throw new RangeError("'byteOffset' must be an integer.");if(m<0||m>=f.byteLength)throw new RangeError(`'byteOffset' is out of range [0, ${f.byteLength}).`);if(g=t.byteLength-m,typeof a=="number"){if(g=a,!Number.isSafeInteger(g))throw new RangeError("'byteLength' must be an integer.");if(g<=0||m+g>f.byteLength)throw new RangeError(`'byteLength' is out of range (0, ${f.byteLength-m}].`);if(typeof n=="object"&&n!==null)o=n;else if(typeof n<"u")throw new TypeError("'options' must be an object.")}else if(typeof a<"u")throw new TypeError("'byteLength' must be a number.")}else if(typeof i<"u")throw new TypeError("'options' must be an object.");r=new Uint8Array(f,m,g)}else throw new TypeError("Unexpected argument[0]: must be 'path' or 'buffer'.");let[u,p]=await Jl(o),d=await u.createInferenceSessionHandler(r,p);return bt("InferenceSession.create"),Le(),new gd(d)}startProfiling(){this.handler.startProfiling()}endProfiling(){this.handler.endProfiling()}get inputNames(){return this.handler.inputNames}get outputNames(){return this.handler.outputNames}get inputMetadata(){return this.handler.inputMetadata}get outputMetadata(){return this.handler.outputMetadata}}}),Ra,ym=q(()=>{_m(),Ra=md}),bm=q(()=>{}),wm=q(()=>{}),$m=q(()=>{}),vm=q(()=>{}),_d={};Gt(_d,{InferenceSession:()=>Ra,TRACE:()=>fi,TRACE_EVENT_BEGIN:()=>yt,TRACE_EVENT_END:()=>bt,TRACE_FUNC_BEGIN:()=>Xe,TRACE_FUNC_END:()=>Le,Tensor:()=>Ye,env:()=>be,registerBackend:()=>Bt});var Ve=q(()=>{dm(),cm(),ym(),fd(),bm(),wm(),hd(),$m(),vm()}),Ba=q(()=>{}),yd={};Gt(yd,{default:()=>bd});var $r,vr,bd,xm=q(()=>{var e;Tf(),Pt(),Na(),$r="ort-wasm-proxy-worker",vr=((e=globalThis.self)==null?void 0:e.name)===$r,vr&&(self.onmessage=t=>{let{type:i,in:a}=t.data;try{switch(i){case"init-wasm":Da(a.wasm).then(()=>{Ja(a).then(()=>{postMessage({type:i})},n=>{postMessage({type:i,err:n})})},n=>{postMessage({type:i,err:n})});break;case"init-ep":{let{epName:n,env:r}=a;en(r,n).then(()=>{postMessage({type:i})},o=>{postMessage({type:i,err:o})});break}case"copy-from":{let{buffer:n}=a,r=Hi(n);postMessage({type:i,out:r});break}case"create":{let{model:n,options:r}=a;tn(n,r).then(o=>{postMessage({type:i,out:o})},o=>{postMessage({type:i,err:o})});break}case"release":rn(a),postMessage({type:i});break;case"run":{let{sessionId:n,inputIndices:r,inputs:o,outputIndices:u,options:p}=a;an(n,r,o,u,new Array(u.length).fill(null),p).then(d=>{d.some(f=>f[3]!=="cpu")?postMessage({type:i,err:"Proxy does not support non-cpu tensor location."}):postMessage({type:i,out:d},sn([...o,...d]))},d=>{postMessage({type:i,err:d})});break}case"end-profiling":nn(a),postMessage({type:i});break;default:}}catch(n){postMessage({type:i,err:n})}}),bd=vr?null:t=>new Worker(t??Pe,{type:"module",name:$r})}),wd={};Gt(wd,{default:()=>$d});var xr,$d,$s,Cm=q(()=>{var e,t;xr=async function(i={}){var ys;var a,n,r=i,o=new Promise((s,l)=>{a=s,n=l}),u=typeof window=="object",p=typeof WorkerGlobalScope<"u",d=p&&((ys=self.name)==null?void 0:ys.startsWith("em-pthread"));r.mountExternalData=(s,l)=>{s.startsWith("./")&&(s=s.substring(2)),(r.Fb||(r.Fb=new Map)).set(s,l)},r.unmountExternalData=()=>{delete r.Fb};var f=globalThis.SharedArrayBuffer??new WebAssembly.Memory({initial:0,maximum:0,qc:!0}).buffer.constructor;let m=s=>async(...l)=>{var c;try{if(r.Gb)throw Error("Session already started");let h=r.Gb={ec:l[0],errors:[]},y=await s(...l);if(r.Gb!==h)throw Error("Session mismatch");(c=r.Kb)==null||c.flush();let x=h.errors;if(0<x.length){let I=await Promise.all(x);if(I=I.filter(A=>A),0<I.length)throw Error(I.join(`
`))}return y}finally{r.Gb=null}};r.jsepInit=(s,l)=>{if(s==="webgpu"){[r.Kb,r.Vb,r.Zb,r.Lb,r.Yb,r.Ab,r.$b,r.bc,r.Wb,r.Xb,r.ac]=l;let c=r.Kb;r.jsepRegisterBuffer=(h,y,x,I)=>c.registerBuffer(h,y,x,I),r.jsepGetBuffer=h=>c.getBuffer(h),r.jsepCreateDownloader=(h,y,x)=>c.createDownloader(h,y,x),r.jsepOnCreateSession=h=>{c.onCreateSession(h)},r.jsepOnReleaseSession=h=>{c.onReleaseSession(h)},r.jsepOnRunStart=h=>c.onRunStart(h),r.cc=(h,y)=>{c.upload(h,y)}}else if(s==="webnn"){let c=l[0];[r.oc,r.Ob,r.webnnEnsureTensor,r.Pb,r.webnnDownloadTensor,r.nc,r.webnnEnableTraceEvent]=l.slice(1),r.webnnReleaseTensorId=r.Ob,r.webnnUploadTensor=r.Pb,r.webnnRegisterMLContext=r.nc,r.webnnOnRunStart=h=>c.onRunStart(h),r.webnnOnRunEnd=c.onRunEnd.bind(c),r.webnnOnReleaseSession=h=>{c.onReleaseSession(h)},r.webnnCreateMLTensorDownloader=(h,y)=>c.createMLTensorDownloader(h,y),r.webnnRegisterMLTensor=(h,y,x,I)=>c.registerMLTensor(h,y,x,I),r.webnnCreateMLContext=h=>c.createMLContext(h),r.webnnRegisterMLConstant=(h,y,x,I,A,P)=>c.registerMLConstant(h,y,x,I,A,r.Fb,P),r.webnnRegisterGraphInput=c.registerGraphInput.bind(c),r.webnnIsGraphInput=c.isGraphInput.bind(c),r.webnnRegisterGraphOutput=c.registerGraphOutput.bind(c),r.webnnIsGraphOutput=c.isGraphOutput.bind(c),r.webnnCreateTemporaryTensor=c.createTemporaryTensor.bind(c),r.webnnIsGraphInputOutputTypeSupported=c.isGraphInputOutputTypeSupported.bind(c)}};let g=()=>{let s=(l,c,h)=>(...y)=>{let x=et,I=c==null?void 0:c();y=l(...y);let A=c==null?void 0:c();return I!==A&&(l=A,h(I),c=h=null),et!=x?new Promise((P,W)=>{or={resolve:P,reject:W}}):y};(()=>{for(let l of["_OrtAppendExecutionProvider","_OrtCreateSession","_OrtRun","_OrtRunWithBinding","_OrtBindInput"])r[l]=s(r[l],()=>r[l],c=>r[l]=c)})(),m!==void 0&&(r._OrtRun=m(r._OrtRun),r._OrtRunWithBinding=m(r._OrtRunWithBinding)),g=void 0};r.asyncInit=()=>{g==null||g()};var _,b,w=(s,l)=>{throw l},C=import.meta.url,v="";if(u||p){try{v=new URL(".",C).href}catch{}p&&(b=s=>{var l=new XMLHttpRequest;return l.open("GET",s,!1),l.responseType="arraybuffer",l.send(null),new Uint8Array(l.response)}),_=async s=>{if(V(s))return new Promise((c,h)=>{var y=new XMLHttpRequest;y.open("GET",s,!0),y.responseType="arraybuffer",y.onload=()=>{y.status==200||y.status==0&&y.response?c(y.response):h(y.status)},y.onerror=h,y.send(null)});var l=await fetch(s,{credentials:"same-origin"});if(l.ok)return l.arrayBuffer();throw Error(l.status+" : "+l.url)}}var $,T,k,S,E,z,R,M,L,J,H,j,le,ae,Z,se=console.log.bind(console),Y=console.error.bind(console),te=se,ge=Y,D=!1,V=s=>s.startsWith("file://");function G(){return T.buffer!=E.buffer&&he(),E}function ee(){return T.buffer!=E.buffer&&he(),z}function Te(){return T.buffer!=E.buffer&&he(),R}function Qe(){return T.buffer!=E.buffer&&he(),M}function U(){return T.buffer!=E.buffer&&he(),L}function _e(){return T.buffer!=E.buffer&&he(),J}function Ne(){return T.buffer!=E.buffer&&he(),H}function Ae(){return T.buffer!=E.buffer&&he(),ae}if(d){let s=function(l){try{var c=l.data,h=c.Db;if(h==="load"){let y=[];self.onmessage=x=>y.push(x),self.startWorker=()=>{postMessage({Db:"loaded"});for(let x of y)s(x);self.onmessage=s};for(let x of c.Sb)r[x]&&!r[x].proxy||(r[x]=(...I)=>{postMessage({Db:"callHandler",Rb:x,args:I})},x=="print"&&(te=r[x]),x=="printErr"&&(ge=r[x]));T=c.kc,he(),Z(c.lc)}else if(h==="run"){Mf(c.Bb),fr(c.Bb,0,0,1,0,0),hn(),nr(c.Bb),it||(ss(),it=!0);try{Pf(c.hc,c.Jb)}catch(y){if(y!="unwind")throw y}}else c.target!=="setimmediate"&&(h==="checkMailbox"?it&&mi():h&&(ge(`worker: received unknown command ${h}`),ge(c)))}catch(y){throw os(),y}};var it=!1;self.onunhandledrejection=l=>{throw l.reason||l},self.onmessage=s}function he(){var s=T.buffer;r.HEAP8=E=new Int8Array(s),R=new Int16Array(s),r.HEAPU8=z=new Uint8Array(s),M=new Uint16Array(s),r.HEAP32=L=new Int32Array(s),r.HEAPU32=J=new Uint32Array(s),H=new Float32Array(s),ae=new Float64Array(s),j=new BigInt64Array(s),le=new BigUint64Array(s)}function $e(){d?startWorker(r):B.Da()}var De,vt=0,xt=null;function on(){if(--vt==0&&xt){var s=xt;xt=null,s()}}function dt(s){throw ge(s="Aborted("+s+")"),D=!0,s=new WebAssembly.RuntimeError(s+". Build with -sASSERTIONS for more info."),n(s),s}function un(){return{a:{L:tm,Aa:em,b:qf,$:yn,A:$n,pa:vn,X:xn,Z:Cn,qa:Tn,na:kn,ga:Sn,ma:In,J:En,Y:zn,V:An,oa:On,W:Rn,va:Wf,E:Lf,Q:Vf,O:Gf,D:Ff,v:Kf,s:Zf,P:Yf,z:rh,R:ah,ja:nh,T:sh,aa:oh,M:uh,F:lh,ia:nr,sa:dh,r:ph,Ca:ch,w:mh,o:gh,m:yh,c:tr,Ba:bh,n:wh,j:xh,u:Ch,p:Th,f:kh,t:Sh,l:Ih,e:Eh,k:zh,h:Ah,g:Oh,d:Rh,da:Bh,ea:Nh,fa:Dh,ba:Hn,ca:Fn,N:Kn,xa:Ph,ua:qh,i:Wh,C:Lh,G:Vh,ta:Uh,x:jh,ra:Gh,U:Hh,q:Mh,y:Fh,K:Kh,S:Zh,za:Yh,ya:Xh,ka:Qn,la:Jn,_:Xi,B:es,I:ts,ha:is,H:rs,a:T,wa:Yi}}}class Ki{constructor(l){bs(this,"name","ExitStatus");this.message=`Program terminated with exit(${l})`,this.status=l}}var ln=s=>{s.terminate(),s.onmessage=()=>{}},Zi=[],dn=s=>{ct.length==0&&(gn(),mn(ct[0]));var l=ct.pop();if(!l)return 6;Ht.push(l),Ct[s.Bb]=l,l.Bb=s.Bb;var c={Db:"run",hc:s.fc,Jb:s.Jb,Bb:s.Bb};return l.postMessage(c,s.Nb),0},pt=0,we=(s,l,...c)=>{for(var h=2*c.length,y=gr(),x=mr(8*h),I=x>>>3,A=0;A<c.length;A++){var P=c[A];typeof P=="bigint"?(j[I+2*A]=1n,j[I+2*A+1]=P):(j[I+2*A]=0n,Ae()[I+2*A+1>>>0]=P)}return s=us(s,0,h,x,l),Ci(y),s};function Yi(s){if(d)return we(0,1,s);if(S=s,!(0<pt)){for(var l of Ht)ln(l);for(l of ct)ln(l);ct=[],Ht=[],Ct={},D=!0}w(0,new Ki(s))}function pn(s){if(d)return we(1,0,s);Xi(s)}var Xi=s=>{if(S=s,d)throw pn(s),"unwind";Yi(s)},ct=[],Ht=[],cn=[],Ct={},fn=s=>{var l=s.Bb;delete Ct[l],ct.push(s),Ht.splice(Ht.indexOf(s),1),s.Bb=0,ls(l)};function hn(){cn.forEach(s=>s())}var mn=s=>new Promise(l=>{s.onmessage=y=>{var x=(y=y.data).Db;if(y.Hb&&y.Hb!=cr()){var I=Ct[y.Hb];I?I.postMessage(y,y.Nb):ge(`Internal error! Worker sent a message "${x}" to target pthread ${y.Hb}, but that thread no longer exists!`)}else x==="checkMailbox"?mi():x==="spawnThread"?dn(y):x==="cleanupThread"?fn(Ct[y.ic]):x==="loaded"?(s.loaded=!0,l(s)):y.target==="setimmediate"?s.postMessage(y):x==="callHandler"?r[y.Rb](...y.args):x&&ge(`worker sent an unknown command ${x}`)},s.onerror=y=>{throw ge(`worker sent an error! ${y.filename}:${y.lineno}: ${y.message}`),y};var c,h=[];for(c of[])r.propertyIsEnumerable(c)&&h.push(c);s.postMessage({Db:"load",Sb:h,kc:T,lc:k})});function gn(){var s=new Worker((()=>{let l=URL;return import.meta.url>"file:"&&import.meta.url<"file;"?new l("ort.bundle.min.mjs",import.meta.url):new URL(import.meta.url)})(),{type:"module",workerData:"em-pthread",name:"em-pthread"});ct.push(s)}var Mf=s=>{he();var l=_e()[s+52>>>2>>>0];s=_e()[s+56>>>2>>>0],cs(l,l-s),Ci(l)},Pf=(s,l)=>{pt=0,s=fs(s,l),0<pt?S=s:hr(s)};class Uf{constructor(l){this.Ib=l-24}}function qf(s,l,c){var h=new Uf(s>>>=0);throw l>>>=0,c>>>=0,_e()[h.Ib+16>>>2>>>0]=0,_e()[h.Ib+4>>>2>>>0]=l,_e()[h.Ib+8>>>2>>>0]=c,s}function _n(s,l,c,h){return d?we(2,1,s,l,c,h):yn(s,l,c,h)}function yn(s,l,c,h){if(s>>>=0,c>>>=0,h>>>=0,f===void 0)return 6;var y=[];return d&&y.length===0?_n(s,l>>>=0,c,h):(s={fc:c,Bb:s,Jb:h,Nb:y},d?(s.Db="spawnThread",postMessage(s,y),0):dn(s))}var bn=typeof TextDecoder<"u"?new TextDecoder:void 0,wn=(s,l=0,c=NaN)=>{var h=(l>>>=0)+c;for(c=l;s[c]&&!(c>=h);)++c;if(16<c-l&&s.buffer&&bn)return bn.decode(s.buffer instanceof ArrayBuffer?s.subarray(l,c):s.slice(l,c));for(h="";l<c;){var y=s[l++];if(128&y){var x=63&s[l++];if((224&y)==192)h+=String.fromCharCode((31&y)<<6|x);else{var I=63&s[l++];65536>(y=(240&y)==224?(15&y)<<12|x<<6|I:(7&y)<<18|x<<12|I<<6|63&s[l++])?h+=String.fromCharCode(y):(y-=65536,h+=String.fromCharCode(55296|y>>10,56320|1023&y))}}else h+=String.fromCharCode(y)}return h},Ce=(s,l)=>(s>>>=0)?wn(ee(),s,l):"";function $n(s,l,c){return d?we(3,1,s,l,c):0}function vn(s,l){if(d)return we(4,1,s,l)}function xn(s,l){if(d)return we(5,1,s,l)}function Cn(s,l,c){if(d)return we(6,1,s,l,c)}function Tn(s,l,c){return d?we(7,1,s,l,c):0}function kn(s,l){if(d)return we(8,1,s,l)}function Sn(s,l,c){if(d)return we(9,1,s,l,c)}function In(s,l,c,h){if(d)return we(10,1,s,l,c,h)}function En(s,l,c,h){if(d)return we(11,1,s,l,c,h)}function zn(s,l,c,h){if(d)return we(12,1,s,l,c,h)}function An(s){if(d)return we(13,1,s)}function On(s,l){if(d)return we(14,1,s,l)}function Rn(s,l,c){if(d)return we(15,1,s,l,c)}var Bn,Wf=()=>dt(""),Je=s=>{for(var l="";ee()[s>>>0];)l+=Bn[ee()[s++>>>0]];return l},Qi={},Ji={},qt=r.BindingError=class extends Error{constructor(s){super(s),this.name="BindingError"}};function rt(s,l,c={}){return(function(h,y,x={}){var I=y.name;if(!h)throw new qt(`type "${I}" must have a positive integer typeid pointer`);if(Ji.hasOwnProperty(h)){if(x.Tb)return;throw new qt(`Cannot register type '${I}' twice`)}Ji[h]=y,Qi.hasOwnProperty(h)&&(y=Qi[h],delete Qi[h],y.forEach(A=>A()))})(s,l,c)}var Nn=(s,l,c)=>{switch(l){case 1:return c?h=>G()[h>>>0]:h=>ee()[h>>>0];case 2:return c?h=>Te()[h>>>1>>>0]:h=>Qe()[h>>>1>>>0];case 4:return c?h=>U()[h>>>2>>>0]:h=>_e()[h>>>2>>>0];case 8:return c?h=>j[h>>>3]:h=>le[h>>>3];default:throw new TypeError(`invalid integer width (${l}): ${s}`)}};function Lf(s,l,c){c>>>=0,rt(s>>>=0,{name:l=Je(l>>>0),fromWireType:h=>h,toWireType:function(h,y){if(typeof y!="bigint"&&typeof y!="number")throw y=y===null?"null":(h=typeof y)=="object"||h==="array"||h==="function"?y.toString():""+y,new TypeError(`Cannot convert "${y}" to ${this.name}`);return typeof y=="number"&&(y=BigInt(y)),y},Cb:ft,readValueFromPointer:Nn(l,c,l.indexOf("u")==-1),Eb:null})}var ft=8;function Vf(s,l,c,h){rt(s>>>=0,{name:l=Je(l>>>0),fromWireType:function(y){return!!y},toWireType:function(y,x){return x?c:h},Cb:ft,readValueFromPointer:function(y){return this.fromWireType(ee()[y>>>0])},Eb:null})}var er=[],at=[];function tr(s){9<(s>>>=0)&&--at[s+1]==0&&(at[s]=void 0,er.push(s))}var Oe=s=>{if(!s)throw new qt(`Cannot use deleted val. handle = ${s}`);return at[s]},We=s=>{switch(s){case void 0:return 2;case null:return 4;case!0:return 6;case!1:return 8;default:let l=er.pop()||at.length;return at[l]=s,at[l+1]=1,l}};function ir(s){return this.fromWireType(_e()[s>>>2>>>0])}var jf={name:"emscripten::val",fromWireType:s=>{var l=Oe(s);return tr(s),l},toWireType:(s,l)=>We(l),Cb:ft,readValueFromPointer:ir,Eb:null};function Gf(s){return rt(s>>>0,jf)}var Hf=(s,l)=>{switch(l){case 4:return function(c){return this.fromWireType(Ne()[c>>>2>>>0])};case 8:return function(c){return this.fromWireType(Ae()[c>>>3>>>0])};default:throw new TypeError(`invalid float width (${l}): ${s}`)}};function Ff(s,l,c){c>>>=0,rt(s>>>=0,{name:l=Je(l>>>0),fromWireType:h=>h,toWireType:(h,y)=>y,Cb:ft,readValueFromPointer:Hf(l,c),Eb:null})}function Kf(s,l,c,h,y){if(s>>>=0,c>>>=0,l=Je(l>>>0),y===-1&&(y=4294967295),y=A=>A,h===0){var x=32-8*c;y=A=>A<<x>>>x}var I=l.includes("unsigned")?function(A,P){return P>>>0}:function(A,P){return P};rt(s,{name:l,fromWireType:y,toWireType:I,Cb:ft,readValueFromPointer:Nn(l,c,h!==0),Eb:null})}function Zf(s,l,c){function h(x){var I=_e()[x>>>2>>>0];return x=_e()[x+4>>>2>>>0],new y(G().buffer,x,I)}var y=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array][l];rt(s>>>=0,{name:c=Je(c>>>0),fromWireType:h,Cb:ft,readValueFromPointer:h},{Tb:!0})}var Tt=(s,l,c)=>{var h=ee();if(l>>>=0,0<c){var y=l;c=l+c-1;for(var x=0;x<s.length;++x){var I=s.charCodeAt(x);if(55296<=I&&57343>=I&&(I=65536+((1023&I)<<10)|1023&s.charCodeAt(++x)),127>=I){if(l>=c)break;h[l++>>>0]=I}else{if(2047>=I){if(l+1>=c)break;h[l++>>>0]=192|I>>6}else{if(65535>=I){if(l+2>=c)break;h[l++>>>0]=224|I>>12}else{if(l+3>=c)break;h[l++>>>0]=240|I>>18,h[l++>>>0]=128|I>>12&63}h[l++>>>0]=128|I>>6&63}h[l++>>>0]=128|63&I}}h[l>>>0]=0,s=l-y}else s=0;return s},rr=s=>{for(var l=0,c=0;c<s.length;++c){var h=s.charCodeAt(c);127>=h?l++:2047>=h?l+=2:55296<=h&&57343>=h?(l+=4,++c):l+=3}return l};function Yf(s,l){rt(s>>>=0,{name:l=Je(l>>>0),fromWireType:function(c){for(var h,y=_e()[c>>>2>>>0],x=c+4,I=x,A=0;A<=y;++A){var P=x+A;A!=y&&ee()[P>>>0]!=0||(I=Ce(I,P-I),h===void 0?h=I:(h+="\0",h+=I),I=P+1)}return nt(c),h},toWireType:function(c,h){h instanceof ArrayBuffer&&(h=new Uint8Array(h));var y=typeof h=="string";if(!(y||ArrayBuffer.isView(h)&&h.BYTES_PER_ELEMENT==1))throw new qt("Cannot pass non-string to std::string");var x=y?rr(h):h.length,I=xi(4+x+1),A=I+4;return _e()[I>>>2>>>0]=x,y?Tt(h,A,x+1):ee().set(h,A>>>0),c!==null&&c.push(nt,I),I},Cb:ft,readValueFromPointer:ir,Eb(c){nt(c)}})}var Dn=typeof TextDecoder<"u"?new TextDecoder("utf-16le"):void 0,Xf=(s,l)=>{for(var c=s>>1,h=c+l/2;!(c>=h)&&Qe()[c>>>0];)++c;if(32<(c<<=1)-s&&Dn)return Dn.decode(ee().slice(s,c));for(c="",h=0;!(h>=l/2);++h){var y=Te()[s+2*h>>>1>>>0];if(y==0)break;c+=String.fromCharCode(y)}return c},Qf=(s,l,c)=>{if(c??(c=2147483647),2>c)return 0;var h=l;c=(c-=2)<2*s.length?c/2:s.length;for(var y=0;y<c;++y){var x=s.charCodeAt(y);Te()[l>>>1>>>0]=x,l+=2}return Te()[l>>>1>>>0]=0,l-h},Jf=s=>2*s.length,eh=(s,l)=>{for(var c=0,h="";!(c>=l/4);){var y=U()[s+4*c>>>2>>>0];if(y==0)break;++c,65536<=y?(y-=65536,h+=String.fromCharCode(55296|y>>10,56320|1023&y)):h+=String.fromCharCode(y)}return h},th=(s,l,c)=>{if(l>>>=0,c??(c=2147483647),4>c)return 0;var h=l;c=h+c-4;for(var y=0;y<s.length;++y){var x=s.charCodeAt(y);if(55296<=x&&57343>=x&&(x=65536+((1023&x)<<10)|1023&s.charCodeAt(++y)),U()[l>>>2>>>0]=x,(l+=4)+4>c)break}return U()[l>>>2>>>0]=0,l-h},ih=s=>{for(var l=0,c=0;c<s.length;++c){var h=s.charCodeAt(c);55296<=h&&57343>=h&&++c,l+=4}return l};function rh(s,l,c){if(s>>>=0,l>>>=0,c=Je(c>>>=0),l===2)var h=Xf,y=Qf,x=Jf,I=A=>Qe()[A>>>1>>>0];else l===4&&(h=eh,y=th,x=ih,I=A=>_e()[A>>>2>>>0]);rt(s,{name:c,fromWireType:A=>{for(var P,W=_e()[A>>>2>>>0],F=A+4,ie=0;ie<=W;++ie){var ue=A+4+ie*l;ie!=W&&I(ue)!=0||(F=h(F,ue-F),P===void 0?P=F:(P+="\0",P+=F),F=ue+l)}return nt(A),P},toWireType:(A,P)=>{if(typeof P!="string")throw new qt(`Cannot pass non-string to C++ string type ${c}`);var W=x(P),F=xi(4+W+l);return _e()[F>>>2>>>0]=W/l,y(P,F+4,W+l),A!==null&&A.push(nt,F),F},Cb:ft,readValueFromPointer:ir,Eb(A){nt(A)}})}function ah(s,l){rt(s>>>=0,{Ub:!0,name:l=Je(l>>>0),Cb:0,fromWireType:()=>{},toWireType:()=>{}})}function nh(s){fr(s>>>0,!p,1,!u,131072,!1),hn()}var ar=s=>{if(!D)try{if(s(),!(0<pt))try{d?hr(S):Xi(S)}catch(l){l instanceof Ki||l=="unwind"||w(0,l)}}catch(l){l instanceof Ki||l=="unwind"||w(0,l)}};function nr(s){s>>>=0,typeof Atomics.jc=="function"&&(Atomics.jc(U(),s>>>2,s).value.then(mi),s+=128,Atomics.store(U(),s>>>2,1))}var mi=()=>{var s=cr();s&&(nr(s),ar(ps))};function sh(s,l){(s>>>=0)==l>>>0?setTimeout(mi):d?postMessage({Hb:s,Db:"checkMailbox"}):(s=Ct[s])&&s.postMessage({Db:"checkMailbox"})}var sr=[];function oh(s,l,c,h,y){for(l>>>=0,h/=2,sr.length=h,c=y>>>0>>>3,y=0;y<h;y++)sr[y]=j[c+2*y]?j[c+2*y+1]:Ae()[c+2*y+1>>>0];return(l?pr[l]:Jh[s])(...sr)}var uh=()=>{pt=0};function lh(s){s>>>=0,d?postMessage({Db:"cleanupThread",ic:s}):fn(Ct[s])}function dh(s){}var gi=(s,l)=>{var c=Ji[s];if(c===void 0)throw s=ns(s),c=Je(s),nt(s),new qt(`${l} has unknown type ${c}`);return c},Mn=(s,l,c)=>{var h=[];return s=s.toWireType(h,c),h.length&&(_e()[l>>>2>>>0]=We(h)),s};function ph(s,l,c){return l>>>=0,c>>>=0,s=Oe(s>>>0),l=gi(l,"emval::as"),Mn(l,c,s)}function ch(s,l){return l>>>=0,s=Oe(s>>>0),(l=gi(l,"emval::as")).toWireType(null,s)}var _i=s=>{try{s()}catch(l){dt(l)}},ht=0,et=null,Pn=0,yi=[],Un={},qn={},fh=0,or=null,hh=[];function Wn(s){return(function(l){if(!D){if(ht===0){var c=!1,h=!1;l((y=0)=>{if(!D&&(Pn=y,c=!0,h)){ht=2,_i(()=>gs(et)),typeof MainLoop<"u"&&MainLoop.Qb&&MainLoop.resume(),y=!1;try{var x=(function(){var P=U()[et+8>>>2>>>0];return P=B[qn[P]],--pt,P()})()}catch(P){x=P,y=!0}var I=!1;if(!et){var A=or;A&&(or=null,(y?A.reject:A.resolve)(x),I=!0)}if(y&&!I)throw x}}),h=!0,c||(ht=1,et=(function(){var y=xi(65548),x=y+12;_e()[y>>>2>>>0]=x,_e()[y+4>>>2>>>0]=x+65536,x=yi[0];var I=Un[x];return I===void 0&&(I=fh++,Un[x]=I,qn[I]=x),x=I,U()[y+8>>>2>>>0]=x,y})(),typeof MainLoop<"u"&&MainLoop.Qb&&MainLoop.pause(),_i(()=>hs(et)))}else ht===2?(ht=0,_i(_s),nt(et),et=null,hh.forEach(ar)):dt(`invalid state: ${ht}`);return Pn}})(l=>{s().then(l)})}function mh(s){return s>>>=0,Wn(async()=>{var l=await Oe(s);return We(l)})}var bi=[];function gh(s,l,c,h){return c>>>=0,h>>>=0,(s=bi[s>>>0])(null,l=Oe(l>>>0),c,h)}var _h={},wi=s=>{var l=_h[s];return l===void 0?Je(s):l};function yh(s,l,c,h,y){return c>>>=0,h>>>=0,y>>>=0,(s=bi[s>>>0])(l=Oe(l>>>0),l[c=wi(c)],h,y)}function bh(s,l){return l>>>=0,(s=Oe(s>>>0))==Oe(l)}var Ln=()=>typeof globalThis=="object"?globalThis:Function("return this")();function wh(s){return(s>>>=0)==0?We(Ln()):(s=wi(s),We(Ln()[s]))}var $h=s=>{var l=bi.length;return bi.push(s),l},vh=(s,l)=>{for(var c=Array(s),h=0;h<s;++h)c[h]=gi(_e()[l+4*h>>>2>>>0],`parameter ${h}`);return c};function xh(s,l,c){var h=(l=vh(s,l>>>0)).shift();s--;var y=`return function (obj, func, destructorsRef, args) {
...
`)},type:g,offsetToIndices:k,indicesToOffset:z,broadcastedIndicesToOffset:H,indices:R,indicesGet:M,indicesSet:L,set:(...D)=>{if(D.length!==o+1)throw new Error(`indices length must be ${o}`);let V=D[o];if(typeof V!="string")throw new Error("value must be string");let G=D.slice(0,o).map(_).join(",");return o===0?j("0u",V):o===1?j(G[0],V):(b.set=!0,b.setByIndices=!0,b.indicesToOffset=!0,`set_${e}(${G}, ${V})`)},setByOffset:j,setByIndices:(D,V)=>o<2?j(D,V):(b.setByIndices=!0,b.indicesToOffset=!0,`set_${e}ByIndices(${D}, ${V});`),get:se,getByOffset:le,getByIndices:Y,usage:a,name:e,strides:v,shape:C,rank:o}},N=(e,t,i,a=1)=>ei(e,t,i,"input",a),K=(e,t,i,a=1)=>ei(e,t,i,"output",a),Nd=(e,t,i)=>ei(e,t,i,"atomicOutput",1),ja=(e,t,i,a=1)=>ei(e,t,i,"internal",a),Fs=class{constructor(e,t){this.normalizedDispatchGroup=e,this.limits=t,this.internalVariables=[],this.variables=[],this.uniforms=[],this.variableIndex=0}guardAgainstOutOfBoundsWorkgroupSizes(e){return`if (global_idx >= ${typeof e=="number"?`${e}u`:e}) { return; }`}mainStart(e=jt){let t=typeof e=="number"?e:e[0],i=typeof e=="number"?1:e[1],a=typeof e=="number"?1:e[2];if(t>this.limits.maxComputeWorkgroupSizeX||i>this.limits.maxComputeWorkgroupSizeY||a>this.limits.maxComputeWorkgroupSizeZ)throw new Error(`workgroup size [${t}, ${i}, ${a}] exceeds the maximum workgroup size [${this.limits.maxComputeWorkgroupSizeX}, ${this.limits.maxComputeWorkgroupSizeY}, ${this.limits.maxComputeWorkgroupSizeZ}].`);if(t*i*a>this.limits.maxComputeInvocationsPerWorkgroup)throw new Error(`workgroup size [${t}, ${i}, ${a}] exceeds the maximum workgroup invocations ${this.limits.maxComputeInvocationsPerWorkgroup}.`);let n=this.normalizedDispatchGroup[1]===1&&this.normalizedDispatchGroup[2]===1,r=n?`@builtin(global_invocation_id) global_id : vec3<u32>,
...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},Dd=(e,t)=>new Fs(e,t)}),Ks,Pr,Zs,Ys,Xs,Qs,qe,Md,Pd,$t=q(()=>{re(),ne(),xe(),oe(),Ks=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},Pr=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),Zs=(e,t)=>O.sortBasedOnPerm(e,Pr(e.length,t)),Ys=(e,t,i,a)=>{let n=`fn perm(i: ${a.type.indices}) -> ${i.type.indices} {
    var a: ${i.type.indices};`;for(let r=0;r<t;++r)n+=`a[${e[r]}]=i[${r}];`;return n+="return a;}"},Xs=(e,t)=>{let i=[],a=[];for(let n=0;n<e.length;++n)e[n]!==1&&i.push(e[n]),e[t[n]]!==1&&a.push(t[n]);return{newShape:i,newPerm:a}},Qs=(e,t)=>{let i=0;for(let a=0;a<e.length;++a)if(t[e[a]]!==1){if(e[a]<i)return!1;i=e[a]}return!0},qe=(e,t)=>{let i=e.dataType,a=e.dims.length,n=Pr(a,t),r=Zs(e.dims,n),o=e.dims,u=r,p=a<2||Qs(n,e.dims),d;if(p)return d=b=>{let w=N("input",i,o,4),C=K("output",i,u,4);return`
  ${b.registerUniform("output_size","u32").declareVariables(w,C)}
  ${b.mainStart()}
    ${b.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    output[global_idx] = input[global_idx];
  }`},{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let b=O.size(r);return{outputs:[{dims:r,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(b/64/4)},programUniforms:[{type:12,data:Math.ceil(b/4)}]}},getShaderSource:d};let{newShape:f,newPerm:m}=Xs(e.dims,n),g=O.areEqual(m,[2,3,1]),_=O.areEqual(m,[3,1,2]);if(f.length===2||g||_){o=g?[f[0],f[1]*f[2]]:_?[f[0]*f[1],f[2]]:f,u=[o[1],o[0]];let b=16;return d=w=>{let C=N("a",i,o.length),v=K("output",i,u.length);return`
    ...
    ${C.setByOffset("global_idx",w.getByIndices("aIndices"))}
  }`},{name:"Transpose",shaderCache:{hint:`${t}`,inputDependencies:["rank"]},getRunData:()=>{let b=O.size(r);return{outputs:[{dims:r,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(b/64)},programUniforms:[{type:12,data:b},...Q(o,u)]}},getShaderSource:d}},Md=(e,t)=>{Ks(e.inputs,t.perm),e.compute(qe(e.inputs[0],t.perm))},Pd=e=>fe({perm:e.perm})}),Js,eo,to,io,ro,ao,no,so,oo,uo,je,Ud,qd,Wd,Ld,Vd,jd,Gd,Hd,Fd,Kd,zm=q(()=>{re(),ne(),oe(),Ga(),$t(),Js={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate * candidate",logSumExp:"bestValue + exp(candidate)",l1:"bestValue + abs(candidate)",l2:"bestValue + candidate * candidate",logSum:"bestValue + candidate"},eo={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate",logSumExp:"bestValue + candidate",l1:"bestValue + candidate",l2:"bestValue + candidate",logSum:"bestValue + candidate"},to={max:"_A[offset]",min:"_A[offset]",mean:"0",sum:"0",prod:"1",sumSquare:"0",logSumExp:"0",l1:"0",l2:"0",logSum:"0"},io={max:"bestValue",min:"bestValue",sum:"bestValue",prod:"bestValue",sumSquare:"bestValue",logSumExp:"log(bestValue)",l1:"bestValue",l2:"sqrt(bestValue)",logSum:"log(bestValue)"},ro=(e,t)=>{let i=[];for(let a=t-e;a<t;++a)i.push(a);return i},ao=(e,t)=>{let i=[],a=e.length;for(let r=0;r<a;r++)t.indexOf(r)===-1&&i.push(e[r]);let n=t.map(r=>e[r]);return[i,n]},no=(e,t)=>{let i=e.length+t.length,a=[],n=0;for(let r=0;r<i;r++)t.indexOf(r)===-1?a.push(e[n++]):a.push(1);return a},so=(e,t)=>{for(let i=0;i<e.length;++i)if(e[e.length-i-1]!==t-1-i)return!1;return!0},oo=(e,t)=>{let i=[];if(!so(e,t)){for(let a=0;a<t;++a)e.indexOf(a)===-1&&i.push(a);e.forEach(a=>i.push(a))}return i},uo=(e,t,i,a,n,r,o)=>{let u=i[0].dims,p=O.size(r),d=O.size(o),f=N("_A",i[0].dataType,u),m=K("output",n,r),g=64;p===1&&(g=256);let _=`
       ...
       `,b=w=>`
        ...
        fn DIV_CEIL(a : u32, b : u32) -> u32 {
         ...
         if (local_idx == 0u) {
          ${m.setByOffset("outputIndex",`${a==="mean"?`${m.type.storage}(bestValue / f32(uniforms.reduceSize))`:`${m.type.storage}(${io[a]})`}`)};
         }
        }`;return{name:e,shaderCache:{hint:`${t};${g}`,inputDependencies:["type"]},getShaderSource:b,getRunData:()=>({outputs:[{dims:r,dataType:n}],dispatchGroup:{x:p},programUniforms:[{type:12,data:d}]})}},je=(e,t,i,a)=>{let n=e.inputs.length===1?i:wa(e.inputs,i),r=n.axes;r.length===0&&!n.noopWithEmptyAxes&&(r=e.inputs[0].dims.map((_,b)=>b));let o=O.normalizeAxes(r,e.inputs[0].dims.length),u=o,p=e.inputs[0],d=oo(u,e.inputs[0].dims.length);d.length>0&&(p=e.compute(qe(e.inputs[0],d),{inputs:[0],outputs:[-1]})[0],u=ro(u.length,p.dims.length));let[f,m]=ao(p.dims,u),g=f;n.keepDims&&(g=no(f,o)),e.compute(uo(t,n.cacheKey,[p],a,e.inputs[0].dataType,g,m),{inputs:[p]})},Ud=(e,t)=>{je(e,"ReduceMeanShared",t,"mean")},qd=(e,t)=>{je(e,"ReduceL1Shared",t,"l1")},Wd=(e,t)=>{je(e,"ReduceL2Shared",t,"l2")},Ld=(e,t)=>{je(e,"ReduceLogSumExpShared",t,"logSumExp")},Vd=(e,t)=>{je(e,"ReduceMaxShared",t,"max")},jd=(e,t)=>{je(e,"ReduceMinShared",t,"min")},Gd=(e,t)=>{je(e,"ReduceProdShared",t,"prod")},Hd=(e,t)=>{je(e,"ReduceSumShared",t,"sum")},Fd=(e,t)=>{je(e,"ReduceSumSquareShared",t,"sumSquare")},Kd=(e,t)=>{je(e,"ReduceLogSumShared",t,"logSum")}}),Ge,lo,Vi,wa,He,po,co,fo,ho,mo,go,_o,yo,bo,wo,Fe,Zd,Yd,Xd,Qd,Jd,ep,tp,ip,rp,ap,Ga=q(()=>{re(),ne(),xe(),oe(),zm(),Ge=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},lo=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Vi=(e,t,i,a,n,r,o=!1,u=!1)=>{let p=[],d=i[0].dims,f=d.length,m=O.normalizeAxes(n,f),g=!u&&m.length===0;d.forEach((w,C)=>{g||m.indexOf(C)>=0?o&&p.push(1):p.push(w)});let _=p.length,b=O.size(p);return{name:e,shaderCache:t,getShaderSource:w=>{let C=[],v=N("_A",i[0].dataType,f),$=K("output",r,_),T=a(v,$,m),k=T[2];for(let S=0,E=0;S<f;S++)g||m.indexOf(S)>=0?(o&&E++,k=`for(var j${S}: u32 = 0; j${S} < ${d[S]}; j${S}++) {
...
`)}
        }`},getRunData:()=>({outputs:[{dims:p,dataType:r}],dispatchGroup:{x:Math.ceil(b/64)},programUniforms:[{type:12,data:b},...Q(d,p)]})}},wa=(e,t)=>{let i=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(a=>i.push(Number(a))),fe({axes:i,keepDims:t.keepDims,noopWithEmptyAxes:t.noopWithEmptyAxes})},He=(e,t,i,a)=>{let n=e.inputs,r=n.length===1?i:wa(n,i);e.compute(Vi(t,{hint:r.cacheKey,inputDependencies:["rank"]},[n[0]],r.noopWithEmptyAxes&&r.axes.length===0?lo:a,r.axes,n[0].dataType,r.keepDims,r.noopWithEmptyAxes),{inputs:[0]})},po=(e,t)=>{Ge(e.inputs),He(e,"ReduceLogSum",t,(i,a)=>[`var value = ${a.type.storage}(0);`,"",`value += ${i.getByIndices("input_indices")};`,"value = log(value);"])},co=(e,t)=>{Ge(e.inputs),He(e,"ReduceL1",t,(i,a)=>[`var value = ${a.type.storage}(0);`,"",`value += abs(${i.getByIndices("input_indices")});`,""])},fo=(e,t)=>{Ge(e.inputs),He(e,"ReduceL2",t,(i,a)=>[`var t = ${a.type.value}(0); var value = ${a.type.value}(0);`,"",`t = ${i.getByIndices("input_indices")}; value += (t * t);`,"value = sqrt(value);"])},ho=(e,t)=>{Ge(e.inputs),He(e,"ReduceLogSumExp",t,(i,a)=>[`var value = ${a.type.storage}(0);`,"",`value += exp(${i.getByIndices("input_indices")});`,"value = log(value);"])},mo=(e,t)=>{Ge(e.inputs),He(e,"ReduceMax",t,(i,a,n)=>{let r=[];for(let o=0;o<i.rank;o++)(n.indexOf(o)>=0||n.length===0)&&r.push(i.indicesSet("input_indices",o,0));return[`${r.join(`
`)}`,`var value = ${i.getByIndices("input_indices")};`,`value = max(value, ${i.getByIndices("input_indices")});`,""]})},go=(e,t)=>{Ge(e.inputs),He(e,"ReduceMean",t,(i,a,n)=>{let r=1;for(let o=0;o<i.rank;o++)(n.indexOf(o)>=0||n.length===0)&&(r*=e.inputs[0].dims[o]);return["var sum = f32(0);","",`sum += f32(${i.getByIndices("input_indices")});`,`let value = ${a.type.value}(sum / ${r});`]})},_o=(e,t)=>{Ge(e.inputs),He(e,"ReduceMin",t,(i,a,n)=>{let r=[];for(let o=0;o<i.rank;o++)(n.indexOf(o)>=0||n.length===0)&&r.push(`input_indices[${o}] = 0;`);return[`${r.join(`
`)}`,`var value = ${i.getByIndices("input_indices")};`,`value = min(value, ${i.getByIndices("input_indices")});`,""]})},yo=(e,t)=>{Ge(e.inputs),He(e,"ReduceProd",t,(i,a)=>[`var value = ${a.type.storage}(1);`,"",`value *= ${i.getByIndices("input_indices")};`,""])},bo=(e,t)=>{Ge(e.inputs),He(e,"ReduceSum",t,(i,a)=>[`var value = ${a.type.storage}(0);`,"",`value += ${i.getByIndices("input_indices")};`,""])},wo=(e,t)=>{Ge(e.inputs),He(e,"ReduceSumSquare",t,(i,a)=>[`var t = ${a.type.value}(0); var value = ${a.type.value}(0);`,"",`t = ${i.getByIndices("input_indices")}; value += t * t;`,""])},Fe=(e,t,i)=>{if(t.length===0)return i;let a=1,n=1;for(let r=0;r<t.length;r++)t.indexOf(r)===-1?a*=e[r]:n*=e[r];return n<32&&a>1024},Zd=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?go(e,t):Ud(e,t)},Yd=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?co(e,t):qd(e,t)},Xd=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?fo(e,t):Wd(e,t)},Qd=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?ho(e,t):Ld(e,t)},Jd=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?mo(e,t):Vd(e,t)},ep=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?_o(e,t):jd(e,t)},tp=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?yo(e,t):Gd(e,t)},ip=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?bo(e,t):Hd(e,t)},rp=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?wo(e,t):Fd(e,t)},ap=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?po(e,t):Kd(e,t)}}),Ur,np,sp,$a,Am=q(()=>{re(),xe(),Ga(),Ur=e=>{if(!e||e.length===0||e.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(e[0].dataType!==1)throw new Error("Invalid input type.")},np=(e,t)=>{Ur(e.inputs);let i=(a,n,r)=>{let o=[];for(let u=0;u<a.rank;u++)(r.indexOf(u)>=0||r.length===0)&&o.push(`input_indices[${u}] = 0;`);return[`${o.join(`
...
var best_index : i32 = 0;`,`if (${a.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`};return e.compute({name:"AttentionPrepare",shaderCache:{inputDependencies:["type","type","type"]},getRunData:()=>({outputs:[{dims:i,dataType:e.inputs[0].dataType,gpuDataType:0},{dims:i,dataType:e.inputs[0].dataType,gpuDataType:0},{dims:i,dataType:e.inputs[0].dataType,gpuDataType:0}],dispatchGroup:u,programUniforms:d}),getShaderSource:f},{inputs:p,outputs:[-1,-1,-1]})},op=(e,t)=>{let i=$o(e.inputs,t),[a,n,r]=To(e,i);return hi(e,a,n,r,e.inputs[4],void 0,void 0,void 0,e.inputs[5],i)}}),ko,So,Io,up,Om=q(()=>{Ve(),re(),ne(),xe(),oe(),ko=(e,t)=>{if(!e||e.length!==5)throw new Error("BatchNormalization requires 5 inputs");let i=(a,n,r)=>{let o=n.length;if(o!==a.length)throw new Error(`${r}: num dimensions != ${o}`);n.forEach((u,p)=>{if(u!==a[p])throw new Error(`${r}: dim[${p}] do not match`)})};if(e[0].dims.length>1){let a=t.format==="NHWC"?t.spatial?e[0].dims.slice(-1):e[0].dims.slice(-1).concat(e[0].dims.slice(1,e[0].dims.length-1)):e[0].dims.slice(1,t.spatial?2:void 0);i(e[1].dims,a,"Invalid input scale"),i(e[2].dims,a,"Invalid input B"),i(e[3].dims,a,"Invalid input mean"),i(e[4].dims,a,"Invalid input var")}else i(e[1].dims,[1],"Invalid input scale"),i(e[2].dims,[1],"Invalid input B"),i(e[3].dims,[1],"Invalid input mean"),i(e[4].dims,[1],"Invalid input var")},So=(e,t)=>{let{epsilon:i,spatial:a,format:n}=t,r=e[0].dims,o=a?ve(r[r.length-1]):1,u=n==="NHWC"&&r.length>1?o:1,p=O.size(r)/o,d=a,f=d?r.length:r,m=N("x",e[0].dataType,e[0].dims,o),g=N("scale",e[1].dataType,e[1].dims,u),_=N("bias",e[2].dataType,e[2].dims,u),b=N("inputMean",e[3].dataType,e[3].dims,u),w=N("inputVar",e[4].dataType,e[4].dims,u),C=K("y",e[0].dataType,f,o),v=()=>{let T="";if(a)T=`let cOffset = ${r.length===1?"0u":n==="NHWC"?`outputIndices[${r.length-1}] / ${o}`:"outputIndices[1]"};`;else if(n==="NCHW")T=`
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${a}_${o}`,inputDependencies:d?["rank","type","type","type","type"]:void 0},getShaderSource:$,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:d?[{type:12,data:p},...Q(r)]:[{type:12,data:p}]})}},Io=e=>fe(e),up=(e,t)=>{let{inputs:i,outputCount:a}=e,n=Io({...t,outputCount:a});if(be.webgpu.validateInputContent&&ko(i,n),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(So(i,n))}}),Eo,zo,lp,Rm=q(()=>{ne(),oe(),Eo=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},zo=e=>{let t=e[0].dims,i=e[0].dims[2],a=O.size(t)/4,n=e[0].dataType,r=N("input",n,t,4),o=N("bias",n,[i],4),u=N("residual",n,t,4),p=K("output",n,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:d=>`
  ...
  }`}},lp=e=>{Eo(e.inputs),e.compute(zo(e.inputs))}}),Ao,pe,dp,pp,cp,fp,hp,mp,gp,_p,yp,Oo,bp,wp,$p,vp,li,xp,Ui,Cp,Tp,kp,Sp,Ip,Ep,zp,Ap,Op,Rp,Bp,Np,Dp,Mp,Pp,Up,qr,qp,va,xa,Wp,Lp,Vp,Ro,Bo,jp,Fa=q(()=>{re(),ne(),xe(),oe(),Ao=(e,t,i,a,n,r,o)=>{let u=Math.ceil(t/4),p="";typeof n=="string"?p=`${n}(a)`:p=n("a");let d=N("inputData",i,[u],4),f=K("outputData",a,[u],4),m=[{name:"vec_size",type:"u32"}];return o&&m.push(...o),`
  ...
  }`},pe=(e,t,i,a,n,r=e.dataType,o,u)=>{let p=[{type:12,data:Math.ceil(O.size(e.dims)/4)}];return o&&p.push(...o),{name:t,shaderCache:{hint:n,inputDependencies:["type"]},getShaderSource:d=>Ao(d,O.size(e.dims),e.dataType,r,i,a,u),getRunData:d=>({outputs:[{dims:e.dims,dataType:r}],dispatchGroup:{x:Math.ceil(O.size(d[0].dims)/64/4)},programUniforms:p})}},dp=e=>{e.compute(pe(e.inputs[0],"Abs","abs"))},pp=e=>{e.compute(pe(e.inputs[0],"Acos","acos"))},cp=e=>{e.compute(pe(e.inputs[0],"Acosh","acosh"))},fp=e=>{e.compute(pe(e.inputs[0],"Asin","asin"))},hp=e=>{e.compute(pe(e.inputs[0],"Asinh","asinh"))},mp=e=>{e.compute(pe(e.inputs[0],"Atan","atan"))},gp=e=>{e.compute(pe(e.inputs[0],"Atanh","atanh"))},_p=e=>fe(e),yp=(e,t)=>{let i;switch(t.to){case 10:i="vec4<f16>";break;case 1:i="vec4<f32>";break;case 12:i="vec4<u32>";break;case 6:i="vec4<i32>";break;case 9:i="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(pe(e.inputs[0],"Cast",i,void 0,t.cacheKey,t.to))},Oo=e=>{let t,i,a=e.length>=2&&e[1].data!==0,n=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=a?e[1].getFloat32Array()[0]:-34028234663852886e22,i=n?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=a?e[1].getUint16Array()[0]:64511,i=n?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return fe({min:t,max:i})},bp=(e,t)=>{let i=t||Oo(e.inputs),a=ze(e.inputs[0].dataType);e.compute(pe(e.inputs[0],"Clip",n=>`clamp(${n}, vec4<${a}>(uniforms.min), vec4<${a}>(uniforms.max))`,void 0,i.cacheKey,void 0,[{type:e.inputs[0].dataType,data:i.min},{type:e.inputs[0].dataType,data:i.max}],[{name:"min",type:a},{name:"max",type:a}]),{inputs:[0]})},wp=e=>{e.compute(pe(e.inputs[0],"Ceil","ceil"))},$p=e=>{e.compute(pe(e.inputs[0],"Cos","cos"))},vp=e=>{e.compute(pe(e.inputs[0],"Cosh","cosh"))},li=e=>fe(e),xp=(e,t)=>{let i=ze(e.inputs[0].dataType);e.compute(pe(e.inputs[0],"Elu",a=>`elu_vf32(${a})`,`
...
`,xa=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Wp=e=>{let t=ze(e.inputs[0].dataType);e.compute(pe(e.inputs[0],"FastGelu",xa,va(t),void 0,e.inputs[0].dataType))},Lp=(e,t)=>{let i=ze(e.inputs[0].dataType);return e.compute(pe(e.inputs[0],"ThresholdedRelu",a=>`select(vec4<${i}>(0.0), ${a}, ${a} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${i}>(${t.alpha});`,t.cacheKey)),0},Vp=e=>{e.compute(pe(e.inputs[0],"Log","log"))},Ro=(e,t)=>`
...
`,Bo=e=>`quick_gelu_impl(${e})`,jp=(e,t)=>{let i=ze(e.inputs[0].dataType);e.compute(pe(e.inputs[0],"QuickGelu",Bo,Ro(i,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),No,Do,Gp,Bm=q(()=>{ne(),oe(),Fa(),No=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Do=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let i=N("input",e[0].dataType,e[0].dims,4),a=N("bias",e[0].dataType,[e[0].dims[2]],4),n=K("output",e[0].dataType,t,4),r=O.size(t)/4,o=Se(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    ${n.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${v}
      }`},Po=(e,t,i,a,n,r,o=i.dataType)=>{let u=i.dims.map(w=>Number(w)??1),p=a.dims.map(w=>Number(w)??1),d=!O.areEqual(u,p),f=u,m=O.size(u),g=!1,_=!1,b=[d];if(d){let w=Vt.calcShape(u,p,!1);if(!w)throw new Error("Can't perform binary op on the given tensors");f=w.slice(),m=O.size(f);let C=O.size(u)===1,v=O.size(p)===1,$=u.length>0&&u[u.length-1]%4===0,T=p.length>0&&p[p.length-1]%4===0;b.push(C),b.push(v),b.push($),b.push(T);let k=1;for(let S=1;S<f.length;S++){let E=u[u.length-S],z=p[p.length-S];if(E===z)k*=E;else break}k%4===0?(_=!0,g=!0):(C||v||$||T)&&(g=!0)}else g=!0;return b.push(g),{name:e,shaderCache:{hint:t+b.map(w=>w.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:w=>Mo(w,u,p,f,g,d,_,n,i.dataType,a.dataType,o,r),getRunData:()=>({outputs:[{dims:f,dataType:o}],dispatchGroup:{x:Math.ceil(m/64/4)},programUniforms:[{type:12,data:Math.ceil(O.size(f)/4)},...Q(u,p,f)]})}},Ke=(e,t,i,a,n,r)=>{e.compute(Po(t,n??"",e.inputs[0],e.inputs[1],i,a,r))},Hp=e=>{Ke(e,"Add",(t,i)=>`${t}+${i}`)},Fp=e=>{Ke(e,"Div",(t,i)=>`${t}/${i}`)},Kp=e=>{Ke(e,"Equal",{scalar:(t,i)=>`u32(${t}==${i})`,vector:(t,i)=>`vec4<u32>(${t}==${i})`},void 0,void 0,9)},Zp=e=>{Ke(e,"Mul",(t,i)=>`${t}*${i}`)},Yp=e=>{let t=N("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Ke(e,"Pow",{scalar:(i,a)=>`pow_custom(${i},${a})`,vector:(i,a)=>`pow_vector_custom(${i},${a})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},Xp=e=>{Ke(e,"Sub",(t,i)=>`${t}-${i}`)},Qp=e=>{Ke(e,"Greater",{scalar:(t,i)=>`u32(${t}>${i})`,vector:(t,i)=>`vec4<u32>(${t}>${i})`},void 0,void 0,9)},Jp=e=>{Ke(e,"Less",{scalar:(t,i)=>`u32(${t}<${i})`,vector:(t,i)=>`vec4<u32>(${t}<${i})`},void 0,void 0,9)},ec=e=>{Ke(e,"GreaterOrEqual",{scalar:(t,i)=>`u32(${t}>=${i})`,vector:(t,i)=>`vec4<u32>(${t}>=${i})`},void 0,void 0,9)},tc=e=>{Ke(e,"LessOrEqual",{scalar:(t,i)=>`u32(${t}<=${i})`,vector:(t,i)=>`vec4<u32>(${t}<=${i})`},void 0,void 0,9)}}),Uo,qo,Wo,Lo,ic,rc,Dm=q(()=>{re(),ne(),xe(),oe(),Uo=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let i=0,a=e[i],n=a.dataType,r=a.dims.length;e.forEach((o,u)=>{if(u!==i){if(o.dataType!==n)throw new Error("input tensors should be one type");if(o.dims.length!==r)throw new Error("input tensors should have the same shape");o.dims.forEach((p,d)=>{if(d!==t&&p!==a.dims[d])throw new Error("non concat dimensions must match")})}})},qo=(e,t)=>`
  fn calculateInputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
  }`,Wo=(e,t)=>{let i=e.length,a=[];for(let n=0;n<i;++n){let r=t.setByOffset("global_idx",e[n].getByIndices("indices"));i===1?a.push(r):n===0?a.push(`if (inputIndex == ${n}u) { ${r} }`):n===i-1?a.push(`else { ${r} }`):a.push(`else if (inputIndex == ${n}) { ${r} }`)}return a.join(`
`)},Lo=(e,t,i,a)=>{let n=O.size(i),r=new Array(e.length),o=new Array(e.length),u=0,p=[],d=[],f=[{type:12,data:n}];for(let w=0;w<e.length;++w)u+=e[w].dims[t],r[w]=u,d.push(e[w].dims.length),o[w]=N(`input${w}`,a,d[w]),p.push("rank"),f.push({type:12,data:r[w]});for(let w=0;w<e.length;++w)f.push(...Q(e[w].dims));f.push(...Q(i));let m=K("output",a,i.length),g=m.indicesGet("indices",t),_=Array.from(Array(r.length).keys()).map(w=>`uniforms.sizeInConcatAxis${w}`).join(","),b=w=>`
...
`}),pi,Ya,Xa=q(()=>{re(),ne(),oe(),Ut(),pi=(e,t,i,a,n)=>{let r=a-i;return`
...
`},Ya=(e,t,i,a,n=!1,r)=>{let o=e[0].dims,u=e[1].dims,p=o[o.length-2],d=u[u.length-1],f=o[o.length-1],m=ve(d),g=ve(f),_=ve(p),b=O.size(i)/m/_,w=e.length>2,C=a?a.slice(0,-2):i.slice(0,-2),v=[O.size(C),p,d],$=[{type:12,data:b},{type:12,data:p},{type:12,data:d},{type:12,data:f}];Dt(t,$),$.push(...Q(C,o,u)),w&&$.push(...Q(e[2].dims)),$.push(...Q(v));let T=k=>{let S=ja("batch_dims",e[0].dataType,C.length),E=N("a",e[0].dataType,o.length,g),z=N("b",e[1].dataType,u.length,m),R=K("output",e[0].dataType,v.length,m),M=Se(R.type.tensor),L=Nt(t,R.type.value,M),J=[E,z],H="";if(w){let ae=n?m:1;J.push(N("bias",e[2].dataType,e[2].dims.length,ae)),H=`${n?`value += bias[col / ${ae}];`:`value += ${R.type.value}(bias[row + i]);`}`}let j=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];Mt(t,j);let le=()=>{let ae=`var a_data: ${E.type.value};`;for(let Z=0;Z<g;Z++)ae+=`
...
`}return ae};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${m};${g};${_};${n}`,inputDependencies:w?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r?r(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(b/64)},programUniforms:$}),getShaderSource:T}}}),Vo,jo,Ca,Wr,Go,Ta,Ho,ji,Qa=q(()=>{re(),ne(),oe(),Ut(),Xa(),Za(),Vo=(e,t)=>e?`
...
`},Ho=(e,t,i,a,n=!1)=>{let[r,o,u,p]=a,d=Se(a[0].type.tensor);return`
  ...
  ${w?Ca(C,v,Z,ae):Ta(C,v,Z,ae)}
    ...
    return ${Ee(u,d)}(0.0);`,S=Ee(p,d),E=Ee(e?o:u,d),z=Ee(e?u:o,d),R=Nt(r,S,d);return`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${S}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${w?`vec4<${te}>`:te}) {
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${T} {
          ...
          }`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${o};${f};${b}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:d[0],y:d[1],z:d[2]},programUniforms:g}),getShaderSource:w}}}),lc,dc,qm=q(()=>{re(),ne(),oe(),Ut(),lc=(e,t,i,a)=>{let n=e.length>2,r=n?"value += b[output_channel];":"",o=e[0].dims,u=e[1].dims,p=t.format==="NHWC",d=p?i[3]:i[1],f=d/t.group,m=p&&f>=4?ve(d):1,g=O.size(i)/m,_=[{type:12,data:g},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:f}];Dt(t,_),_.push(...Q(o,[u[0],u[1],u[2],u[3]/m]));let b=n?["rank","rank","rank"]:["rank","rank"];_.push(...Q([i[0],i[1],i[2],i[3]/m]));let w=C=>{let v=K("output",e[0].dataType,i.length,m),$=Se(v.type.tensor),T=Nt(t,v.type.value,$),k=N("x",e[0].dataType,o.length),S=N("w",e[1].dataType,u.length,m),E=[k,S];n&&E.push(N("b",e[2].dataType,e[2].dims,m));let z=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];Mt(t,z);let R=p?`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${m}`,inputDependencies:b},getRunData:()=>({outputs:[{dims:a?a(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(g/64)},programUniforms:_}),getShaderSource:w}},dc=(e,t,i,a)=>{let n=e.length>2,r=ve(i[3]),o=ve(i[2]),u=O.size(i)/r/o,p=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/r],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/r],f=[i[0],i[1],i[2],i[3]/r],m=[{type:12,data:u},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];Dt(t,m),m.push(...Q(p,d,f));let g=(o-1)*t.strides[1]+d[1],_=b=>{let w=K("output",e[0].dataType,f.length,r),C=Se(w.type.tensor),v=Nt(t,w.type.value,C),$=N("x",e[0].dataType,p.length,r),T=N("w",e[1].dataType,d.length,r),k=[$,T];n&&k.push(N("b",e[2].dataType,e[2].dims,r));let S=n?"value += b[output_channel];":"",E=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return Mt(t,E),`
  ...
  ${b.mainStart()}
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${r};${o};${g};${d[0]};${d[1]}`,inputDependencies:n?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:a?a(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:m}),getShaderSource:_}}}),Xo,Oi,Qo,Ri,ka,jr,Jo,eu,Sa,Wm=q(()=>{ne(),Pm(),Um(),Qa(),qm(),Ut(),Xa(),$t(),Xo=(e,t,i,a,n,r)=>{let o=e[0],u=e.slice(r?1:2,r?3:4),p=u.length,d=t[0],f=t.slice(2).map((g,_)=>g+(g-1)*(i[_]-1)),m=u.map((g,_)=>g+a[_]+a[_+p]).map((g,_)=>Math.floor((g-f[_]+n[_])/n[_]));return m.splice(0,0,o),m.splice(r?3:1,0,d),m},Oi=[2,3,1,0],Qo=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let i=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],a=e[1].dims[1]*t.group;if(i!==a)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let n=e[0].dims.length-2;if(t.dilations.length!==n)throw new Error(`dilations should be ${n}D`);if(t.strides.length!==n)throw new Error(`strides should be ${n}D`);if(t.pads.length!==n*2)throw new Error(`pads should be ${n*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Ri=(e,t)=>{let i=e.kernelShape.slice();i.length<t[1].dims.length-2&&i.push(...Array(t[1].dims.length-2-i.length).fill(0));for(let r=2;r<t[1].dims.length;++r)i[r-2]===0&&(i[r-2]=t[1].dims[r]);let a=e.pads.slice();Li.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,i,a,e.format==="NHWC",e.autoPad);let n=Object.assign({},e);return Object.assign(n,{kernelShape:i,pads:a}),n},ka=e=>{let t=Ka(e),i=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],n=e.dilations,r=e.group,o=e.kernel_shape,u=e.pads,p=e.strides,d=e.w_is_const();return{autoPad:a,format:i,dilations:n,group:r,kernelShape:o,pads:u,strides:p,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},jr=(e,t,i,a)=>{let n=i.format==="NHWC",r=Xo(t[0].dims,t[1].dims,i.dilations,i.pads,i.strides,n);if(i.group!==1){let E=[t[0]];if(n){let z=e.kernelCustomData.wT??e.compute(qe(t[1],Oi),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=z),E.push(z)}else E.push(t[1]);t.length===3&&E.push(t[2]),!e.adapterInfo.isArchitecture("ampere")&&n&&t[1].dims[0]===i.group&&t[1].dims[1]===1&&i.dilations[0]===1&&i.dilations[1]===1?e.compute(dc(E,i,r,a),{inputs:E}):e.compute(lc(E,i,r,a),{inputs:E});return}let o=t.length===3,u=t[0].dims[n?1:2],p=t[0].dims[n?2:3],d=t[0].dims[n?3:1],f=t[1].dims[2],m=t[1].dims[3],g=r[n?1:2],_=r[n?2:3],b=r[n?3:1],w=n&&f===u&&m===p&&i.pads[0]===0&&i.pads[1]===0;if(w||f===1&&m===1&&i.dilations[0]===1&&i.dilations[1]===1&&i.strides[0]===1&&i.strides[1]===1&&i.pads[0]===0&&i.pads[1]===0){let E=r[0],z,R,M,L=[];if(n){let j=e.kernelCustomData.wT??e.compute(qe(t[1],Oi),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];if(i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=j),w){let le=u*p*d;z=t[0].reshape([1,E,le]),R=j.reshape([1,le,b]),M=[1,E,b]}else z=t[0].reshape([E,u*p,d]),R=j.reshape([1,d,b]),M=[E,g*_,b];L.push(z),L.push(R)}else z=t[0].reshape([E,d,u*p]),R=t[1].reshape([1,b,d]),M=[E,b,g*_],L.push(R),L.push(z);o&&L.push(t[2]);let J=M[2],H=L[0].dims[L[0].dims.length-1];J<8&&H<8?e.compute(Ya(L,i,r,M,n,a),{inputs:L}):e.compute(ji(L,i,r,M,n,a),{inputs:L});return}let C=!0,v=e.kernelCustomData.wT??e.compute(qe(t[1],Oi),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=v);let $=[t[0],v];o&&$.push(t[2]);let T=n?g*_:b,k=n?b:g*_,S=f*m*d;e.compute(sc($,i,r,T,k,S,o,C,a),{inputs:$})},Jo=(e,t)=>{let i=t.format==="NHWC",a=[e.inputs[0].reshape(i?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&a.push(e.inputs[2]);let n=[0,t.pads[0],0,t.pads[1]],r=[1].concat(t.strides),o=[1].concat(t.dilations),u=[1].concat(t.kernelShape),p=Ri({...t,pads:n,strides:r,dilations:o,kernelShape:u},a);jr(e,a,p,d=>i?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},eu=(e,t,i)=>{let a=i.format==="NHWC"?"channelsLast":"channelsFirst",n=Ri(i,t),r=i.autoPad==="NOTSET"?i.pads:i.autoPad,o=oc(t[0].dims,t[1].dims,i.strides,i.dilations,r,!1,a);e.compute(uc(t,n,o.outShape,[o.filterDepth,o.filterHeight,o.filterWidth],[o.padInfo.front,o.padInfo.top,o.padInfo.left],a))},Sa=(e,t)=>{if(Qo(e.inputs,t),e.inputs[0].dims.length===3)Jo(e,t);else if(e.inputs[0].dims.length===5)eu(e,e.inputs,t);else{let i=Ri(t,e.inputs);jr(e,e.inputs,i)}}}),pc,Lm=q(()=>{re(),lt(),ne(),oe(),pc=(e,t,i)=>{let a=e.length>2,n=t.outputShape,r=t.format==="NHWC",o=t.group,u=e[1].dims,p=u[2]/o,d=u[3],f=r?ve(p):1,m=r&&d===1&&p>=4,g=m?Math.floor(p/4)*4:Math.floor(p/f)*f,_=p-g,b=r?ve(d):1,w=r?d===1?f:b:1,C=O.size(n)/b,v=[Math.ceil(C/64),1,1];de("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${v}`);let $=["rank","rank"],T=[t.strides[0],t.strides[1]],k=[t.kernelShape[r?1:2],t.kernelShape[r?2:3]],S=[t.dilations[0],t.dilations[1]],E=[k[0]+(t.dilations[0]<=1?0:(t.kernelShape[r?1:2]-1)*(t.dilations[0]-1)),k[1]+(t.dilations[1]<=1?0:(t.kernelShape[r?2:3]-1)*(t.dilations[1]-1))],z=[E[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),E[1]-1-Math.floor((t.pads[1]+t.pads[3])/2)],R=[{type:12,data:C},{type:12,data:T},{type:12,data:k},{type:12,data:S},{type:12,data:E},{type:6,data:z},{type:12,data:g},{type:12,data:p},{type:12,data:d},...Q(e[0].dims,e[1].dims)];a&&(R.push(...Q(e[2].dims)),$.push("rank")),R.push(...Q(n));let M=L=>{let J=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:T.length},{name:"filter_dims",type:"u32",length:k.length},{name:"dilations",type:"u32",length:k.length},{name:"effective_filter_dims",type:"u32",length:E.length},{name:"pads",type:"i32",length:z.length},{name:"input_channels_per_group_int",type:"u32"},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],H=Se(e[0].dataType),j=r?1:2,le=r?2:3,ae=r?3:1,Z=N("W",e[1].dataType,e[1].dims.length,w),se=N("Dy",e[0].dataType,e[0].dims.length,f),Y=[se,Z];a&&Y.push(N("bias",e[2].dataType,[n[ae]].length,b));let te=K("result",e[0].dataType,n.length,b),ge=()=>{let G="";if(m)f===4?G+=`
    ...
    ${V}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};${f}${w}${b}${m}${_}`,inputDependencies:$},getRunData:()=>({dispatchGroup:{x:v[0],y:v[1],z:v[2]},outputs:[{dims:i?i(n):n,dataType:e[0].dataType}],programUniforms:R}),getShaderSource:M}}}),tu,iu,ru,Gr,cc,au,Hr,nu,fc,Vm=q(()=>{Lm(),Ut(),$t(),tu=(e,t,i,a,n,r)=>(e-1)*t+i+(a-1)*n+1-r,iu=(e,t,i,a,n)=>{let r=Math.floor(e/2);t==="SAME_UPPER"?(i[a]=r,i[n]=e-r):t==="SAME_LOWER"&&(i[a]=e-r,i[n]=r)},ru=(e,t,i,a,n,r,o,u,p,d)=>{let f=e.length-2,m=d.length===0;p.length<f&&p.push(...Array(f-p.length).fill(0));let g=e[0],_=t[u?3:1]*n;for(let b=0,w=e.length-f-(u?1:0);b<f;++b,++w){let C=e[w],v=m?C*o[b]:d[b],$=tu(C,o[b],r[b],t[w],i[b],v);iu($,a,r,b,b+f),m&&d.push(o[b]*(C-1)+p[b]+(t[w]-1)*i[b]+1-r[b]-r[b+f])}d.splice(0,0,g),d.splice(u?3:1,0,_)},Gr=(e,t)=>{let i=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((m,g)=>m*g,1)===0){i.length=0;for(let m=2;m<t[1].dims.length;++m)i.push(t[1].dims[m])}let a=e.format==="NHWC";i.splice(0,0,t[1].dims[0]),i.splice(a?3:1,0,t[1].dims[1]);let n=e.pads.slice(),r=e.outputShape.slice(),o=e.outputPadding.slice(),u=t[0].dims,p=e.dilations.slice();if(p.reduce((m,g)=>m+g,0)===0){let m=t[0].dims.length-2;p=new Array(m).fill(1)}let d=e.strides.slice();if(d.reduce((m,g)=>m+g,0)===0){let m=t[0].dims.length-2;d=new Array(m).fill(1)}ru(u,i,p,e.autoPad,e.group,n,d,a,o,r);let f=Object.assign({},e);return Object.assign(f,{kernelShape:i,pads:n,outputPadding:o,outputShape:r,dilations:p,strides:d}),f},cc=e=>{let t=Ka(e),i=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],n=e.dilations,r=e.group,o=e.kernelShape,u=e.pads,p=e.strides,d=e.wIsConst(),f=e.outputPadding,m=e.outputShape;return{autoPad:a,format:i,dilations:n,group:r,kernelShape:o,outputPadding:f,outputShape:m,pads:u,strides:p,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},au=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let i=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],a=e[1].dims[0];if(i!==a)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let n=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==n))throw new Error("invalid bias");let r=e[0].dims.length-2;if(t.dilations.reduce((o,u)=>o+u,0)>0&&t.dilations.length!==r)throw new Error(`dilations should be ${r}D`);if(t.strides.reduce((o,u)=>o+u,0)>0&&t.strides.length!==r)throw new Error(`strides should be ${r}D`);if(t.pads.reduce((o,u)=>o+u,0)>0&&t.pads.length!==r*2)throw new Error(`pads should be ${r*2}D`);if(t.outputPadding.length!==r&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${r}D`);if(t.kernelShape.reduce((o,u)=>o+u,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},Hr=(e,t,i,a)=>{let n=e.kernelCustomData.wT??e.compute(qe(t[1],[2,3,0,1]),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=n);let r=[t[0],n];t.length===3&&r.push(t[2]),e.compute(pc(r,i,a),{inputs:r})},nu=(e,t)=>{let i=t.format==="NHWC",a=[e.inputs[0].reshape(i?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&a.push(e.inputs[2]);let n=t.kernelShape;(n.length===0||n[0]===0)&&(n=[e.inputs[1].dims[2]]);let r=t.dilations;(r.length===0||r[0]===0)&&(r=[1]);let o=t.strides;(o.length===0||o[0]===0)&&(o=[1]);let u=t.pads;u.length===0&&(u=[0,0]),u=[0,u[0],0,u[1]],o=[1].concat(o),r=[1].concat(r),n=[1].concat(n);let p=t.outputPadding;p=[0].concat(p);let d=Gr({...t,pads:u,strides:o,dilations:r,kernelShape:n,outputPadding:p},a);Hr(e,a,d,f=>i?[f[0],f[2],f[3]]:[f[0],f[1],f[3]])},fc=(e,t)=>{if(au(e.inputs,t),e.inputs[0].dims.length===3)nu(e,t);else{let i=Gr(t,e.inputs);Hr(e,e.inputs,i)}}}),su,hc,mc,jm=q(()=>{re(),ne(),xe(),oe(),su=(e,t,i,a)=>{let n=O.size(t),r=t.length,o=N("input",e,r),u=K("output",e,r),p=i.dataType===6?i.getInt32Array()[0]:Number(i.getBigInt64Array()[0]),d=O.normalizeAxis(p,r),f=m=>{let g=` i32(${o.indicesGet("inputIndices","uniforms.axis")}) `,_=X("uniforms.input_shape","uniforms.axis",r),b=a.reverse?g+(a.exclusive?" + 1":""):"0",w=a.reverse?_:g+(a.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:a.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:[{type:12,data:n},{type:12,data:d},...Q(t,t)]}),getShaderSource:f}},hc=(e,t)=>{let i=e.inputs[0].dims,a=e.inputs[0].dataType,n=e.inputs[1];e.compute(su(a,i,n,t),{inputs:[0]})},mc=e=>{let t=e.exclusive===1,i=e.reverse===1;return fe({exclusive:t,reverse:i})}}),ou,uu,lu,gc,_c,Gm=q(()=>{re(),ne(),xe(),oe(),ou=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},uu=(e,t,i,a)=>{let n=[];n.push(`fn perm(i: ${a.type.indices}) -> ${i.type.indices} {
    var a: ${i.type.indices};`);for(let r=0;r<t;++r)n.push(i.indicesSet("a",e[r],`i[${r}]`));return n.push("return a;}"),n.join(`
`)},lu=(e,t)=>{let i,a,n,r,o,u,p=t.format==="NHWC",d=t.blocksize,f=t.mode==="DCR";p?([i,a,n,r]=e.dims,o=f?[i,a,n,d,d,r/d**2]:[i,a,n,r/d**2,d,d],u=f?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([i,a,n,r]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],o=f?[i,d,d,r/d**2,a,n]:[i,r/d**2,d,d,a,n],u=f?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let m=e.reshape(o),g=m.dims.length,_=e.dataType,b=N("a",_,g),w=K("output",_,g),C=v=>`
  ...
  }`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:v=>{let $=p?[i,a*d,n*d,r/d**2]:[i,r/d**2,a*d,n*d],T=O.size($),k=m.dims,S=O.sortBasedOnPerm(k,u);return{outputs:[{dims:$,dataType:v[0].dataType}],dispatchGroup:{x:Math.ceil(T/64)},programUniforms:[{type:12,data:T},...Q(k,S)]}},getShaderSource:C}},gc=(e,t)=>{ou(e.inputs),e.compute(lu(e.inputs[0],t))},_c=e=>fe({blocksize:e.blocksize,mode:e.mode,format:e.format})}),Bi,ii,Fr,du,pu,cu,fu,Kr,hu,yc,bc,Hm=q(()=>{re(),ne(),xe(),oe(),Bi="[a-zA-Z]|\\.\\.\\.",ii="("+Bi+")+",Fr="^"+ii+"$",du="("+ii+",)*"+ii,pu="^"+du+"$",cu=class{constructor(e=-1){this.symbolToIndices=new Map,this.inputIndex=e}addSymbol(e,t){let i=this.symbolToIndices.get(e);i===void 0?i=[t]:i.push(t),this.symbolToIndices.set(e,i)}},fu=class{constructor(e,t){var n;this.equation=t,this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[i,a]=t.includes("->")?t.split("->",2):[t,""];if(!i.match(RegExp(pu)))throw new Error("Invalid LHS term");if(i.split(",").forEach((r,o)=>{let u=e[o].dims.slice();if(!r.match(RegExp(Fr)))throw new Error("Invalid LHS term");let p=this.processTerm(r,!0,u,o);this.lhs.push(p)}),a==="")a+=[...this.symbolToInfo.entries()].filter(([r,o])=>o.count===1||r==="...").map(([r])=>r).join("");else if(!a.match(RegExp(ii)))throw new Error("Invalid RHS");(n=a.match(RegExp(Bi,"g")))==null||n.forEach(r=>{if(r==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let o=this.symbolToInfo.get(r);if(o===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(o.dimValue)}}),this.rhs=this.processTerm(a,!1,this.outputDims)}addSymbol(e,t,i){let a=this.symbolToInfo.get(e);if(a!==void 0){if(a.dimValue!==t&&a.count!==1)throw new Error("Dimension mismatch");a.count++,a.inputIndices.push(i)}else a={count:1,dimValue:t,inputIndices:[i]};this.symbolToInfo.set(e,a)}processTerm(e,t,i,a=-1){let n=i.length,r=!1,o=[],u=0;if(!e.match(RegExp(Fr))&&!t&&e!=="")throw new Error("Invalid LHS term");let p=e.match(RegExp(Bi,"g")),d=new cu(a);return p==null||p.forEach((f,m)=>{if(f==="..."){if(r)throw new Error("Only one ellipsis is allowed per input term");r=!0;let g=n-p.length+1;if(g<0)throw new Error("Ellipsis out of bounds");if(o=i.slice(u,u+g),this.hasEllipsis){if(this.ellipsisDims.length!==o.length||this.ellipsisDims.toString()!==o.toString())throw new Error("Ellipsis dimensions mismatch")}else if(t)this.hasEllipsis=!0,this.ellipsisDims=o;else throw new Error("Ellipsis must be specified in the LHS");for(let _=0;_<o.length;_++){let b=String.fromCharCode(48+_);d.addSymbol(b,m+_),this.addSymbol(b,i[u++],a)}}else d.addSymbol(f,m+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(f,i[u++],a)}),d}},Kr=e=>e+"_max",hu=(e,t,i,a)=>{let n=e.map(d=>d.length).map((d,f)=>N(`input${f}`,t,d)),r=O.size(a),o=K("output",t,a.length),u=[...i.symbolToInfo.keys()].filter(d=>!i.rhs.symbolToIndices.has(d)),p=d=>{let f=[],m="var prod = 1.0;",g="var sum = 0.0;",_="sum += prod;",b=[],w=[],C=[],v=[],$=i.symbolToInfo.size===i.rhs.symbolToIndices.size;i.symbolToInfo.forEach((k,S)=>{var E;if(i.rhs.symbolToIndices.has(S)){let z=(E=i.rhs.symbolToIndices.get(S))==null?void 0:E[0];z!==void 0&&i.lhs.forEach((R,M)=>{if(k.inputIndices.includes(M)){let L=R.symbolToIndices.get(S);if(L===void 0)throw new Error("Invalid symbol error");L.forEach(J=>{f.push(`${n[M].indicesSet(`input${M}Indices`,J,o.indicesGet("outputIndices",z))}`)})}})}else i.lhs.forEach((z,R)=>{if(k.inputIndices.includes(R)){let M=z.symbolToIndices.get(S);if(M===void 0)throw new Error("Invalid symbol error");M.forEach(L=>{b.push(`${n[R].indicesSet(`input${R}Indices`,L,`${S}`)}`)}),v.push(`prod *= ${n[R].getByIndices(`input${R}Indices`)};`)}}),w.push(`for(var ${S}: u32 = 0; ${S} < uniforms.${Kr(S)}; ${S}++) {`),C.push("}")});let T=$?[...f,`let sum = ${n.map((k,S)=>k.getByIndices(`input${S}Indices`)).join(" * ")};`]:[...f,g,...w,...b,m,...v,_,...C];return`
...
`)};
          ...
          }`};return{name:"Einsum",shaderCache:{hint:i.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let d=u.filter(m=>i.symbolToInfo.has(m)).map(m=>{var g;return{type:12,data:((g=i.symbolToInfo.get(m))==null?void 0:g.dimValue)||0}});d.push({type:12,data:r});let f=e.map((m,g)=>[...Q(m)]).reduce((m,g)=>m.concat(g),d);return f.push(...Q(a)),{outputs:[{dims:a,dataType:t}],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:f}},getShaderSource:p}},yc=(e,t)=>{let i=new fu(e.inputs,t.equation),a=i.outputDims,n=e.inputs.map((r,o)=>r.dims);e.compute(hu(n,e.inputs[0].dataType,i,a))},bc=e=>{let t=e.equation.replace(/\s+/g,"");return fe({equation:t})}}),mu,Zr,gu,_u,wc,Fm=q(()=>{re(),ne(),oe(),mu=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,i=Array.from(e[1].getBigInt64Array(),Number),a=i.length<t.length?0:i.length-t.length,n=t.length<i.length?0:t.length-i.length;for(;a<i.length&&n<t.length;++a,++n)if(i[a]!==t[n]&&i[a]!==1&&t[n]!==1)throw new Error("Expand requires shape to be broadcastable to input")},Zr=(e,t)=>{let i=e.length-t.length,a=[];for(let n=0;n<i;++n)a.push(e[n]);for(let n=0;n<t.length;++n)a.push(t[n]===1?e[n+i]:t[n]);return a},gu=(e,t)=>e.length>t.length?Zr(e,t):Zr(t,e),_u=e=>{let t=e[0].dims,i=Array.from(e[1].getBigInt64Array(),Number),a=gu(t,i),n=e[0].dataType,r=n===9||O.size(t)===1,o=n===9||t.length>0&&t[t.length-1]%4===0?4:1,u=r||a.length>0&&a[a.length-1]%4===0?4:1,p=Math.ceil(O.size(a)/u),d=m=>{let g=N("input",n,t.length,o),_=K("output",n,a.length,u),b;if(n===9){let w=(C,v,$="")=>`
    ...
    ${b}`},f=[{type:12,data:p},...Q(t,a)];return{name:"Expand",shaderCache:{hint:`${a.length};${o}${u}`,inputDependencies:["rank"]},getShaderSource:d,getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:f})}},wc=e=>{mu(e.inputs),e.compute(_u(e.inputs),{inputs:[0]})}}),yu,$c,Km=q(()=>{re(),ne(),oe(),Fa(),yu=e=>{let t=e[0].dataType,i=O.size(e[0].dims),a=O.size(e[1].dims),n=a%4===0,r=o=>{let u=N("x",t,[1],4),p=N("bias",t,[1],4),d=K("y",t,[1],4),f=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],m=_=>`
  ...
  ${g.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((_,b)=>b!==1).map(_=>_.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(_,b)=>"rank")},getRunData:()=>({outputs:[{dims:u,dataType:d}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:m}),getShaderSource:g}},kc=(e,t)=>{let i=e.inputs;vu(i,t),e.compute(xu(e.inputs,t))},Sc=e=>fe({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),Cu,Tu,Ic,Ec,Qm=q(()=>{re(),ne(),xe(),oe(),Cu=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)},Tu=(e,t)=>{let i=e[0].dims,a=e[0].dataType,n=i.length,r=e[1].dims,o=e[1].dataType,u=O.normalizeAxis(t.axis,n),p=i[u],d=r.slice(0),f=O.size(d),m=N("input",a,n),g=N("indicesInput",o,r.length),_=K("output",a,d.length),b=[{type:12,data:f},{type:6,data:p},{type:12,data:u}];return b.push(...Q(i,r,d)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:d,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:b}),getShaderSource:w=>`
  ...
  }`};return m?{name:"GemmShared",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:b},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:d*f},programUniforms:_}),getShaderSource:C}:{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:b},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(g/64)},programUniforms:_}),getShaderSource:w}},zc=e=>{let t=e.transA,i=e.transB,a=e.alpha,n=e.beta;return{transA:t,transB:i,alpha:a,beta:n,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},Ac=(e,t)=>{ku(e.inputs),e.compute(Su(e.inputs,t))}}),tt,ot,St,It,Iu,Eu,zu,Au,Ou,Ru,Bu,Nu,Oc,Rc,eg=q(()=>{re(),ne(),xe(),oe(),[tt,ot,St,It]=[0,1,2,3],Iu=e=>{if(e[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw new Error("grid batch size must match input batch size")},Eu=`
...
`,Bu=(e,t,i)=>(()=>{switch(i.mode){case"nearest":return`
        ...
        `;default:throw new Error(`mode ${i.mode} is not supported`)}})()+`${e.setByOffset("global_idx","result")}`,Nu=(e,t)=>{let i=N("x",e[0].dataType,e[0].dims.length),a=[e[1].dims[0],e[1].dims[1],e[1].dims[2]],n=N("grid",e[1].dataType,a.length,2),r=[e[0].dims[0],e[0].dims[1],e[1].dims[1],e[1].dims[2]];t.format==="NHWC"&&(r=[e[0].dims[0],e[1].dims[1],e[1].dims[2],e[0].dims[3]],[tt,ot,St,It]=[0,3,1,2]);let o=K("output",e[0].dataType,r.length),u=i.type.value,p=O.size(r),d=[{type:12,data:p},...Q(e[0].dims,a,r)],f=m=>`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:u,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:d}),getShaderSource:f},{inputs:[t,i],outputs:[-1]})[0]},di=(e,t,i,a,n,r,o,u)=>{let p=r;if(o&&O.size(o.dims)>0){if(a===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return p=Mu(e,r,o,t,a,i*n,u),p=p.reshape([t,a,i,n]),i===1||a===1?p:e.compute(qe(p,Yr.perm),{inputs:[p],outputs:[-1]})[0]}else return r.dims.length===3&&(p=r.reshape([t,a,i,n])),i===1||a===1?p:e.compute(qe(p,Yr.perm),{inputs:[p],outputs:[-1]})[0]},Nc=(e,t)=>{let i=Du(e.inputs,t),a=e.inputs[0],n=Re(e.inputs,1),r=Re(e.inputs,2),o=Re(e.inputs,3),u=Re(e.inputs,4),p=Re(e.inputs,5),d=Re(e.inputs,6),f=Re(e.inputs,7);if(a.dims.length===5)throw new Error("Packed QKV is not implemented");if((n==null?void 0:n.dims.length)===5)throw new Error("Packed KV is not implemented");let m=n&&r&&n.dims.length===4&&r.dims.length===4,g=di(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,a,o,0);if(m)return hi(e,g,n,r,u,void 0,d,f,p,i);if(!n||!r)throw new Error("key and value must be provided");let _=di(e,i.batchSize,i.numHeads,i.kvSequenceLength,i.headSize,n,o,i.hiddenSize),b=di(e,i.batchSize,i.numHeads,i.kvSequenceLength,i.vHeadSize,r,o,2*i.hiddenSize);hi(e,g,_,b,u,void 0,d,f,p,i)}}),Pu,Uu,qu,Wu,Ia,Mc,Pc,Uc=q(()=>{re(),ne(),xe(),oe(),Pu=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Uu=(e,t)=>{let i=[],a=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(n=>i.push(Number(n))),a=i.length),fe({numOutputs:a,axis:t.axis,splitSizes:i})},qu=e=>`
fn calculateOutputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
}`,Wu=e=>{let t=e.length,i=[];for(let a=0;a<t;++a){let n=e[a].setByIndices("indices","input[global_idx]");t===1?i.push(n):a===0?i.push(`if (output_number == ${a}u) { ${n} }`):a===t-1?i.push(`else { ${n} }`):i.push(`else if (output_number == ${a}) { ${n} }`)}return`
...
`)}
  ...
  `};return{name:"GeneratePositionIds",shaderCache:{hint:`${e};${t}`,inputDependencies:r},getRunData:()=>({outputs:[{dims:o,dataType:n}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:p}),getShaderSource:d}},Lc=(e,t)=>{var k;let i=Vu(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(((k=e.inputs[1])==null?void 0:k.dims.length)===5)throw new Error("Packed KV is not implemented");let a=e.inputs[0],n=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,r=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,o=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,u=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,p=e.inputs.length>4?e.inputs[5]:void 0,d=e.inputs.length>5?e.inputs[6]:void 0,f=i.kvNumHeads?i.kvNumHeads:i.numHeads,m=fe({axis:2,numOutputs:3,splitSizes:[i.numHeads*i.headSize,f*i.headSize,f*i.headSize]}),[g,_,b]=!n&&!r?e.compute(Ia([a],m),{inputs:[a],outputs:[-1,-1,-1]}):[a,n,r],w,C;if(t.doRotary){let S=e.compute(Gu(i.batchSize,i.sequenceLength,p,d),{inputs:[p,d],outputs:[-1]})[0],E=e.inputs[7],z=e.inputs[8],R=fe({interleaved:t.rotaryInterleaved!==0,numHeads:i.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),M=[g,S,E,z],L=[-1];w=e.compute(Gi(M,R),{inputs:M,outputs:L})[0],M.splice(0,1,_);let J=fe({interleaved:t.rotaryInterleaved!==0,numHeads:i.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});C=e.compute(Gi(M,J),{inputs:M,outputs:L})[0]}let v=di(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,t.doRotary?w:g,void 0,0),$=Xr(e,t.doRotary?C:_,i),T=Xr(e,b,i);hi(e,v,$,T,void 0,void 0,o,u,void 0,i,p,d)}}),Qr,Hu,Fu,Vc,ig=q(()=>{re(),ne(),$t(),oe(),Qr=(e,t,i,a,n,r,o,u)=>{let p=ve(r),d=p===1?"f32":`vec${p}f`,f=p===1?"vec2f":`mat2x${p}f`,m=n*o,g=64;m===1&&(g=256);let _=[n,o,r/p],b=[n,o,2],w=["rank","type","type"],C=[];C.push(...Q(_,b));let v=$=>{let T=N("x",t.dataType,3,p),k=N("scale",i.dataType,i.dims),S=N("bias",a.dataType,a.dims),E=K("output",1,3,2),z=[T,k,S,E];return`
  ...
  ${$.mainStart(g)}
    ...
    if (local_idx == 0) {
      let sum_final = ${wt("workgroup_shared[0][0]",p)} / f32(hight * ${p});
      let squared_sum_final = ${wt("workgroup_shared[0][1]",p)} / f32(hight * ${p});
  ...
  }`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${p};${u};${g}`,inputDependencies:w},getRunData:()=>({outputs:[{dims:b,dataType:1}],dispatchGroup:{x:m},programUniforms:C}),getShaderSource:v},{inputs:[t,i,a],outputs:[-1]})[0]},Hu=(e,t,i)=>{let a=t[0].dims,n=a,r=2,o=a[0],u=a[1],p=O.sizeFromDimension(a,r),d=ve(p),f=O.size(n)/d,m=Qr(e,t[0],t[1],t[2],o,p,u,i.epsilon),g=[o,u,p/d],_=[o,u],b=["type","none"],w=C=>{let v=N("x",t[0].dataType,g.length,d),$=N("scale_shift",1,_.length,2),T=K("output",t[0].dataType,g.length,d),k=[v,$,T];return`
  ...
  ${S.mainStart()}
    ...
    let mean = ${wt("mean_vector",b)} / uniforms.norm_size;
    let inv_std_dev = inverseSqrt(${wt("mean_square_vector",b)} / uniforms.norm_size ${a?"":"- mean * mean"} + uniforms.epsilon);
    ...
    ${$?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${m};${g};${C};${w}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:_,dataType:f}],dispatchGroup:{x:k},programUniforms:S}),getShaderSource:M}},Hc=(e,t)=>{Xu(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(Ju(e.inputs,t)):e.compute(Qu(e.inputs,t))},Fc=e=>fe(e)}),el,tl,il,rl,al,nl,sl,ol,Kc,sg=q(()=>{re(),ne(),oe(),el=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},tl=(e,t,i)=>{let a="";for(let n=t-1;n>=0;--n)a+=`
      ...
      `},il=(e,t,i)=>{let a="";for(let n=t-1;n>=0;--n)a+=`
          ...
          `},rl=(e,t,i)=>{let a="";for(let n=t-1;n>=0;--n)a+=`
            ...
            `;return`
              ...
              ${a}
              value = x[offset];
          `},al=(e,t,i)=>{let a="";for(let n=t-1;n>=0;--n)a+=`
                k = i32(${e.indicesGet("indices",n)}) - ${X("uniforms.pads",n,i)};
                if (k < 0)  {
            ...
            `;return`
              ...
              ${a}
              value = x[offset];
          `},nl=(e,t,i)=>{switch(i.mode){case 0:return tl(e,t,i.pads.length);case 1:return il(e,t,i.pads.length);case 2:return rl(e,t,i.pads.length);case 3:return al(e,t,i.pads.length);default:throw new Error("Invalid mode")}},sl=(e,t)=>{let i=O.padShape(e[0].dims.slice(),t.pads),a=e[0].dims,n=O.size(i),r=[{type:12,data:n},{type:6,data:t.pads}],o=e.length>=3&&e[2].data;t.mode===0&&r.push({type:o?e[2].dataType:1,data:t.value}),r.push(...Q(e[0].dims,i));let u=["rank"],p=d=>{let f=K("output",e[0].dataType,i.length),m=N("x",e[0].dataType,a.length),g=m.type.value,_=nl(f,a.length,t),b=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&b.push({name:"constant_value",type:o?g:"f32"}),`
    ...
    `,u="",p=N("x",t.dataType,t.dims.length),d=["rank"],[f,m,g,_,b]=ea(r,n);return f.push(...Q(t.dims,r)),{name:e,shaderCache:{hint:`${a.cacheKey};${g};${_};${b}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:r,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(O.size(r)/64)},programUniforms:f}),getShaderSource:w=>ta(w,p,t.dims.length,r.length,n,o,u,t.dataType===10?-65504:-1e5,m,g,_,b)}},Jc=(e,t)=>{ri(e.inputs),e.compute(sa("MaxPool",e.inputs[0],!1,t))},ef=e=>{let t=e.storage_order,i=e.dilations,a=ra(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(a.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let n={storageOrder:t,dilations:i,...a,cacheKey:""};return{...n,cacheKey:ll(n)}},tf=e=>{let t=e.format;return{format:t,...na,cacheKey:t}},rf=(e,t)=>{ri(e.inputs),e.compute(sa("GlobalMaxPool",e.inputs[0],!0,t))}}),dl,pl,af,nf,ug=q(()=>{re(),ne(),xe(),oe(),dl=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((i,a)=>i===e[2].dims[a]).reduce((i,a)=>i&&a,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((n,r)=>r===t.axis||n===e[0].dims[r]).reduce((n,r)=>n&&r,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let i=e[0].dims[t.axis],a=e[1].dims[t.axis];if(t.blockSize<Math.ceil(i/a)||t.blockSize>Math.ceil(i/(a-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},pl=(e,t)=>{let i=O.normalizeAxis(t.axis,e[0].dims.length),a=e[0].dataType,n=a===3,r=e[0].dims,o=e[1].dataType,u=O.size(r),p=a===3||a===2,d=p?[Math.ceil(O.size(e[0].dims)/4)]:e[0].dims,f=e[1].dims,m=e.length>2?e[2]:void 0,g=m?p?[Math.ceil(O.size(m.dims)/4)]:m.dims:void 0,_=f.length===0||f.length===1&&f[0]===1,b=_===!1&&f.length===1,w=ve(u),C=_&&(!p||w===4),v=C?w:1,$=C&&!p?w:1,T=N("input",p?12:a,d.length,$),k=N("scale",o,f.length),S=m?N("zero_point",p?12:a,g.length):void 0,E=K("output",o,r.length,v),z=[T,k];S&&z.push(S);let R=[d,f];m&&R.push(g);let M=[{type:12,data:u/v},{type:12,data:i},{type:12,data:t.blockSize},...Q(...R,r)],L=J=>{let H=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:S?["rank","rank","rank"]:["rank","rank"]},getShaderSource:L,getRunData:()=>({outputs:[{dims:r,dataType:o}],dispatchGroup:{x:Math.ceil(u/v/64),y:1,z:1},programUniforms:M})}},af=(e,t)=>{dl(e.inputs,t),e.compute(pl(e.inputs,t))},nf=e=>fe({axis:e.axis,blockSize:e.blockSize})}),cl,fl,sf,lg=q(()=>{Ve(),re(),oe(),cl=(e,t,i)=>{let a=e===t,n=e<t&&i<0,r=e>t&&i>0;if(a||n||r)throw new Error("Range these inputs' contents are invalid.")},fl=(e,t,i,a)=>{let n=Math.abs(Math.ceil((t-e)/i)),r=[n],o=n,u=[{type:12,data:o},{type:a,data:e},{type:a,data:i},...Q(r)],p=d=>{let f=K("output",a,r.length),m=f.type.value,g=[{name:"outputSize",type:"u32"},{name:"start",type:m},{name:"delta",type:m}];return`
        ${d.registerUniforms(g).declareVariables(f)}
        ${d.mainStart()}
        ${d.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${m}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${a}`},getShaderSource:p,getRunData:()=>({outputs:[{dims:r,dataType:a}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:u})}},sf=e=>{let t=0,i=0,a=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],i=e.inputs[1].getInt32Array()[0],a=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],i=e.inputs[1].getFloat32Array()[0],a=e.inputs[2].getFloat32Array()[0]),be.webgpu.validateInputContent&&cl(t,i,a),e.compute(fl(t,i,a,e.inputs[0].dataType),{inputs:[]})}}),hl,ml,of,uf,dg=q(()=>{re(),ne(),xe(),oe(),hl=(e,t,i,a)=>{if(e!=="none"&&a!=="i32"&&a!=="u32"&&a!=="f32")throw new Error(`Input ${a} is not supported with reduction ${e}.`);let n=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,r=`;
              ...
              ${n}bitcast<${a}>(oldValue) + (${i})${r}`;case"max":return a==="i32"||a==="u32"?`atomicMax(&${t}, bitcast<${a}>(${i}));`:`
                ${n}max(bitcast<f32>(oldValue), (${i}))${r}`;case"min":return a==="i32"||a==="u32"?`atomicMin(&${t}, bitcast<${a}>(${i}));`:`${n}min(bitcast<${a}>(oldValue), (${i}))${r}`;case"mul":return`${n}(bitcast<${a}>(oldValue) * (${i}))${r}`;default:throw new Error(`Reduction ${e} is not supported.`)}},ml=(e,t)=>{let i=e[0].dims,a=e[1].dims,n=i,r=1,o=Math.ceil(O.sizeToDimension(a,a.length-1)/r),u=a[a.length-1],p=O.sizeFromDimension(i,u),d=[{type:12,data:o},{type:12,data:u},{type:12,data:p},...Q(e[1].dims,e[2].dims,n)],f=m=>{let g=N("indices",e[1].dataType,e[1].dims.length),_=N("updates",e[2].dataType,e[2].dims.length,r),b=t.reduction!=="none"&&t.reduction!==""?Nd("output",e[0].dataType,n.length):K("output",e[0].dataType,n.length,r);return`
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${hl(t.reduction,"output[data_offset + i]","value",b.type.value)}
  }

      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:d}),getShaderSource:f}},of=e=>fe({reduction:e.reduction}),uf=(e,t)=>{e.compute(ml(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),gl,_l,yl,oa,bl,wl,$l,vl,xl,Cl,Tl,kl,ua,Sl,Il,El,zl,Al,lf,df,pg=q(()=>{re(),ne(),xe(),oe(),gl=(e,t)=>{if(e.every(i=>i>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
            one outermost scale values equal to 1, or 5D with two outermost scale values equal to 1`)}else if(t.mode==="cubic"&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},_l=(e,t,i)=>{t.every(n=>n>=0&&n<i||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let a=new Array(i).fill(1);return t.forEach((n,r)=>a[n]=e[r]),a},yl=(e,t,i,a,n,r)=>{let[o,u,p]=i>10?[1,2,3]:[-1,e.length>1?1:-1,-1],d=e[0].dims.length;if(o>0&&e.length>o&&e[o].dims.length>0)e[o].getFloat32Array().forEach(f=>r.push(f));else if(t.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(u>0&&e.length>u&&e[u].dims.length===1&&e[u].dims[0]>0){if(e[u].getFloat32Array().forEach(f=>a.push(f)),a.length!==0&&a.length!==d&&i>=18&&a.length!==t.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");gl(a,t),t.axes.length>0&&_l(a,t.axes,d).forEach((f,m)=>a[m]=f)}if(p>0&&e.length>p&&e[p].dims.length===1&&e[p].dims[0]>0&&(e[p].getBigInt64Array().forEach(f=>n.push(Number(f))),n.length!==0&&n.length!==d&&i>=18&&n.length!==t.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(t.axes.length>0){if(a.length!==0&&a.length!==t.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(n.length!==0&&n.length!==t.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof a<"u"&&typeof n<"u"&&a.length>0&&n.length>d)throw new Error("Resize requires only of scales or sizes to be specified")},oa=(e,t,i,a)=>`
...
`,bl=(e,t)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { `+(()=>{switch(e){case"asymmetric":return`
        ...
        `;case"pytorch_half_pixel":return`if (lengthResized > 1) {
                  ...
                  return offset + ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;case"half_pixel":return`return ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;default:throw new Error(`Coordinate transform mode ${e} is not supported`)}})()+"}",wl=(e,t,i)=>`fn getNearestPixelFromOriginal(xOriginal: ${i}, isDownSample: bool) -> ${i} {`+(()=>{switch(e){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(t<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${e} is not supported`)}})()+"}",$l=(e,t,i)=>{let a=new Array(i).fill(0).concat(new Array(i).fill(1)),n=e.length===0?a:e.slice();return t.length>0?(t.forEach((r,o)=>{a[r]=n[o],a[o+i]=n[t.length+o]}),a):n},vl=(e,t,i,a)=>{let n=[];if(i.length>0)if(a.length>0){if(e.forEach(r=>n.push(r)),Math.max(...a)>e.length)throw new Error("axes is out of bound");a.forEach((r,o)=>n[r]=i[o])}else i.forEach(r=>n.push(r));else{if(t.length===0)throw new Error("Resize requires either scales or sizes.");n=e.map((r,o)=>Math.round(r*t[o]))}return n},xl=(e,t,i)=>{let a=(()=>{switch(i.keepAspectRatioPolicy){case"not_larger":return i.axes.length>0?Math.min(...i.axes.map(r=>t[r]),Number.MAX_VALUE):Math.min(...t,Number.MAX_VALUE);case"not_smaller":return i.axes.length>0?Math.max(...i.axes.map(r=>t[r]),Number.MIN_VALUE):Math.max(...t,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${i.keepAspectRatioPolicy} is not supported`)}})();t.fill(1,0,t.length);let n=e.slice();return i.axes.length>0?(i.axes.forEach(r=>t[r]=a),i.axes.forEach(r=>n[r]=Math.round(e[r]*t[r]))):(t.fill(a,0,t.length),n.forEach((r,o)=>n[o]=Math.round(r*t[o]))),n},Cl=(e,t,i,a,n)=>`
...
`:"",Sl=(e,t,i,a,n)=>{let[r,o,u,p]=i.length===2?[-1,0,1,-1]:[0,2,3,1],d=e.type.value;return`
    ...
    }`},Il=(e,t,i,a,n,r,o,u,p,d)=>{let f=i.length===2,[m,g]=f?[0,1]:[2,3],_=e.type.value,b=w=>{let C=w===m?"row":"col";return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${_} {
    ...
    `},El=(e,t,i,a,n)=>{let[r,o,u,p,d]=i.length===3?[-1,0,1,2,-1]:[0,2,3,4,1],f=e.type.value;return`
    ...
    }`},zl=(e,t,i,a,n,r)=>{let o=e.dims,u=$l(r,t.axes,o.length),p=vl(o,a,n,t.axes),d=a.slice();a.length===0&&(d=o.map(($,T)=>$===0?1:p[T]/$),t.keepAspectRatioPolicy!=="stretch"&&(p=xl(o,d,t)));let f=K("output",e.dataType,p.length),m=N("input",e.dataType,o.length),g=O.size(p),_=o.length===p.length&&o.every(($,T)=>$===p[T]),b=t.coordinateTransformMode==="tf_crop_and_resize",w=t.extrapolationValue,C=m.type.value,v=$=>`
      ${_?"":`
      ${bl(t.coordinateTransformMode,C)};
      ${(()=>{switch(t.mode){case"nearest":return`
              ${kl(m,o)};
              ${wl(t.nearestMode,i,C)};
              ${Tl(m,f,o,p,d.length,u.length,b)};
              `;case"linear":return`
              ${Cl(f,o,p,d.length,u.length)};
              ${(()=>{if(o.length===2||o.length===4)return`${Sl(m,f,o,b,w)}`;if(o.length===3||o.length===5)return`${El(m,f,o,b,w)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
            `;case"cubic":return`
            ${(()=>{if(o.length===2||o.length===4)return`${Il(m,f,o,p,d,u,t.cubicCoeffA,b,t.extrapolationValue,t.excludeOutside)}`;throw Error("Cubic mode only supports input dims 2 and 4 are supported in linear mode.")})()};
...
`}
      ...
      }`,E=e.compute({name:"Softmax",shaderCache:{hint:`${_};${w}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:f,dataType:p.dataType}],dispatchGroup:{x:g},programUniforms:[{type:6,data:b}]}),getShaderSource:S},{inputs:[p],outputs:[u?-1:0]})[0];u&&e.compute(qe(E,d),{inputs:[E]})},hf=(e,t)=>{Pl(e.inputs),Ul(e,t)},mf=e=>fe({axis:e.axis})}),da,ql,Wl,Ll,gf,mg=q(()=>{re(),ne(),oe(),da=e=>Array.from(e.getBigInt64Array(),Number),ql=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==10&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, float16, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(da(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},Wl=(e,t)=>{let i=[];for(let a=0;a<e.length;++a)i.push(e[a]*t[a]);return i},Ll=(e,t)=>{let i=e[0].dims,a=t??da(e[1]),n=Wl(i,a),r=O.size(n),o=e[0].dataType,u=N("input",o,i.length),p=K("output",o,n.length),d=f=>`
 ...
 * limitations under the License.
 * =============================================================================
 */const kg=Object.freeze(Object.defineProperty({__proto__:null,get InferenceSession(){return Ra},get TRACE(){return fi},get TRACE_EVENT_BEGIN(){return yt},get TRACE_EVENT_END(){return bt},get TRACE_FUNC_BEGIN(){return Xe},get TRACE_FUNC_END(){return Le},get Tensor(){return Ye},default:Cg,get env(){return be},get registerBackend(){return Bt}},Symbol.toStringTag,{value:"Module"}));export{kg as o,be as w};
